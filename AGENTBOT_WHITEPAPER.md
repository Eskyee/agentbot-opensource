...
---
## Abstract
Agentbot is open-source infrastructure for autonomous AI agents. Built by the community, for the community. There is no company. it's a zero human company.. There is no VC. There is no team allocation. Just code, contributors, and a shared vision for sustainable open source.
