...
async function main() {
  ...
  process.stderr.write(
    [
      ...
      `- Image size grew ${formatRatioPercent(sizeBudget.increaseRatio)} (${formatBytes(
        comparison.sizeBytes.baseline
      )} -> ${formatBytes(comparison.sizeBytes.current)}), above the ${formatRatioPercent(
        sizeBudget.thresholdRatio
      )} limit.`,
      '',
