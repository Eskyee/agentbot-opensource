...
type EventData<T extends HandleMessageStreamEvent['type']> = Extract<
 ...
 */
export interface SlackChannelInternalEvents
  extends Omit<SlackChannelEvents, 'authorization.required'> {
...
export interface SlackChannel
  extends Channel<SlackChannelState, SlackReceiveTarget, SlackInstrumentationMetadata> {}
