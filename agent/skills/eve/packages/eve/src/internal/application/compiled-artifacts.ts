...
async function createCompiledArtifactsBootstrapSource(input: {
  ...
  return [
    ...
    `import { installBundledCompiledArtifacts } from ${stringifyEsmImportSpecifier(
...
function createInstrumentationPluginSource(input: {
  ...
  return [
    '// Generated by eve. Do not edit by hand.',
    `import * as instrumentationModule from ${stringifyEsmImportSpecifier(
      input.instrumentationPath
    )};`,
    `import { registerInstrumentationConfig } from ${stringifyEsmImportSpecifier(
      input.registerConfigPath
    )};`,
    '',
    'if (instrumentationModule.default != null) {',
    `  registerInstrumentationConfig(instrumentationModule.default, { agentName: ${JSON.stringify(
      input.agentName
    )} });`,
    '}',
    '',
