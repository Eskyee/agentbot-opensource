 ...
 */
export interface PublicToolDefinition<TInput = unknown, TOutput = unknown>
...
export interface InternalToolDefinitionWithExecuteFn<TInput = unknown, TOutput = unknown>
  extends InternalToolDefinition {
  execute: ToolExecuteFn<TInput, TOutput>;
}

export interface PublicToolDefinitionWithExecuteFn<TInput = unknown, TOutput = unknown>
