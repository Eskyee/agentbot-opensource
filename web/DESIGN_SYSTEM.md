...
| `app/wristband/page.tsx` | Gold standard reference page      |
...
*This document is the single source of truth for all Agentbot UI. Every new page, component, or feature must conform to these specifications. When in doubt, reference `/wristband`.*
