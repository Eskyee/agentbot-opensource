...
const capabilities = [
  ...
  { icon: Calendar, label: 'Calendar Guard', desc: 'Protect schedule', color: 'bg-orange-500' },
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-zinc-900 p-6 rounded-2xl">
            ...
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-red-900/30 text-orange-500 text-xs rounded">Telegram</span>
              <span className="px-2 py-1 bg-red-900/30 text-orange-500 text-xs rounded">Discord</span>
          ...
          <div className="bg-zinc-900 p-6 rounded-2xl">
            ...
            <div className="flex gap-2">
              ...
              <span className="px-2 py-1 bg-red-900/30 text-orange-500 text-xs rounded">Base</span>
