...
export default function RemoteAccessForAgentbotAgentsPost() {
    ...
    <main className="min-h-screen bg-black text-white font-mono">
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <header className="mt-10 mb-12">
          <div className="text-[10px] uppercase tracking-widest text-orange-500 mb-4">Guide</div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="border border-zinc-800 bg-zinc-950 p-6 my-8">
            <h2 className="text-sm font-bold uppercase tracking-widest text-orange-500 mb-4">Fast Choice</h2>
          ...
          <p className="text-zinc-400 mb-6">
            With the tunnel open, connect tools and clients to <code className="text-orange-500">ws://127.0.0.1:18789</code>.
  ...
  "remoteAccess": {
    ...
    "hostname": "agentbot-tailnet"
          ...
          <p className="text-zinc-400 mb-6">
            From another Tailnet device, connect to <code className="text-orange-500">http://&lt;tailscale-ip&gt;:18789/</code> or{' '}
            <code className="text-orange-500">ws://&lt;tailscale-ip&gt;:18789</code>.
          </p>
          ...
          <div className="border border-zinc-800 bg-zinc-950 p-6 mt-12">
            <h2 className="text-sm font-bold uppercase tracking-widest text-orange-500 mb-4">Security Rules</h2>
            <ul className="space-y-3 text-sm text-zinc-300">
