      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">Introducing Credit-Based Pricing</h1>
            <div className="flex gap-2">
              <span className="text-xs px-2 py-1 rounded-full bg-gray-800 text-gray-400">Feature</span>
              <span className="text-xs px-2 py-1 rounded-full bg-gray-800 text-gray-400">Pricing</span>
            </div>
          </div>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">Transparent Pricing</h2>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">No Hidden Fees</h2>
          <p className="text-gray-300 mb-4">
          ...
          <div className="mt-12 p-6 rounded-xl bg-gray-900 border border-gray-800">
            <p className="text-gray-300 mb-4">Start with $10 in free credits</p>
