          ...
          <div className="mt-12 space-y-4">
            <div className="p-6 rounded-xl bg-gradient-to-r from-blue-900/30 to-blue-900/30 border border-blue-800">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <Link href="https://raveculture.mintlify.app" className="inline-block border border-zinc-500 text-zinc-300 px-6 py-2.5 rounded-lg font-medium hover:border-zinc-300 transition-colors">
                  View Docs
                </Link>
              </div>
            </div>
