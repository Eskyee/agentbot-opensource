...
export default function Post() {
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">What is Bankr?</h2>
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Step 1: Get Your Bankr API Key</h2>
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Step 2: Connect Your Wallet</h2>
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Step 3: Fund Your Wallet</h2>
 <p className="text-zinc-300 mb-4">Transfer ETH or USDC to your Bankr wallet address. Start with small amounts to test.</p>

 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Trading Commands</h2>
