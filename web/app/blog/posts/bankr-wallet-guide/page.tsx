      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">Guide: Connect Your Bankr Wallet to Agentbot</h1>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What is Bankr?</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Step 1: Get Your Bankr API Key</h2>
          <ol className="list-decimal list-inside text-zinc-300 mb-4">
            <li>Visit <a href="https://bankr.bot/api" className="text-zinc-400 hover:text-white">bankr.bot/api</a></li>
            <li>Sign up with your email</li>
            <li>Generate an API key with agent access</li>
            <li>Copy your key (starts with bk_)</li>
          </ol>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Step 2: Connect Your Wallet</h2>
          <p className="text-zinc-300 mb-4">Bankr automatically provisions wallets on:</p>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Step 3: Fund Your Wallet</h2>
          <p className="text-zinc-300 mb-4">Transfer ETH or USDC to your Bankr wallet address. Start with small amounts to test.</p>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Trading Commands</h2>
