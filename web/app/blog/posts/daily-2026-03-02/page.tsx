...
export default function Post() {
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">What&apos;s New in OpenClaw v2026.3.1</h2>
 ...
 <li className="text-zinc-300 mb-2"><strong>Voice Mode Enhancements</strong> - Improved voice wake and talk mode with better audio quality</li>
 <li className="text-zinc-300 mb-2"><strong>Model Support</strong> - Added support for the latest AI models including Gemini 3 family</li>
 ...
 <li className="text-zinc-300 mb-2">Faster agent response times</li>
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">How to Update</h2>
