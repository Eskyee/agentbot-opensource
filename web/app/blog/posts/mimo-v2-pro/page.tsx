...
export default function MiMoV2ProPost() {
 ...
 <span className="text-xs px-2 py-1 border border-zinc-800 text-zinc-400 border border-red-800/50">New Model</span>
 ...
 <td className="text-right py-2 px-3 text-orange-500 font-mono">#18</td>
 </tr>
 <tr className="border-b border-zinc-800/50">
 <td className="py-2 px-3">Legal</td>
 <td className="text-right py-2 px-3 text-orange-500 font-mono">#21</td>
 </tr>
 <tr className="border-b border-zinc-800/50">
 <td className="py-2 px-3">SEO</td>
 <td className="text-right py-2 px-3 text-orange-500 font-mono">#32</td>
 </tr>
 <tr className="border-b border-zinc-800/50">
 <td className="py-2 px-3">Roleplay</td>
 <td className="text-right py-2 px-3 text-orange-500 font-mono">#43</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <div className="text-2xl font-mono font-bold text-orange-500">2.8s</div>
 ...
 <p className="text-zinc-300 mb-4">
 Or try it right now in our <Link href="/demo" className="text-orange-500 hover:text-orange-500">live demo</Link>.
 </p>
