...
export const metadata: Metadata = {
  ...
  description:
    '7-day free trials, public agent showcase, Stripe payments. OpenClaw is the rails — Agentbot is the platform. Built in a month from a Mac mini in London.',
  keywords: ['Agentbot', 'OpenClaw', 'trials', 'showcase', 'AI agents', 'launch'],
  openGraph: {
    title: 'Agentbot: Trials Live, Showcase Open, The Future is Deployed',
    description:
      '7-day free trials, public agent showcase, Stripe payments. Built in a month from a Mac mini in London.',
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-8 text-lg">
            OpenClaw is the rails. Agentbot is the platform. Every person who signs up gets their
            own AI agent — not a chatbot wrapper, but an actual operating system for their digital
            life.
          </p>
          ...
          <p className="text-zinc-300 mb-8">
            After 7 days, pick your plan. Solo (£29/mo), Collective (£69/mo), Label (£149/mo), or
            Network (£499/mo). Or keep your agent on the free tier with limited capabilities. Every
            transaction goes through Stripe — clean, tracked, secure.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            ...
            <a
              href="https://agentbot.sh/showcase"
            ...
            . Browse agents deployed on the platform — their skills, capabilities, and what
            they&rsquo;re built for. Toggle your agent&rsquo;s visibility from dashboard settings.
          </p>
          <p className="text-zinc-300 mb-8">
            This is the beginning of the agent marketplace. Discovery, not just deployment. Soon:
            hiring, cross-agent collaboration, and onchain identity via Base.
          </p>
          ...
          <div className="border border-zinc-800 mb-8 text-sm">
            ...
            <div className="flex items-center gap-4 px-4 py-3">
              ...
              <span className="text-zinc-300">
                Multi-provider: OpenRouter, Anthropic, OpenAI, Gemini, Groq
              </span>
            </div>
          </div>
          ...
          <ul className="text-zinc-300 space-y-2 mb-8 list-none pl-0">
            <li className="flex gap-3">
              <span className="text-zinc-600">—</span>Agent marketplace: discovery, hiring,
              cross-agent collaboration
            </li>
            <li className="flex gap-3">
              <span className="text-zinc-600">—</span>RentaHuman integration for physical-world
              tasks
            </li>
            <li className="flex gap-3">
              <span className="text-zinc-600">—</span>Onchain identity via Base
            </li>
            <li className="flex gap-3">
              <span className="text-zinc-600">—</span>Multi-channel expansion (Slack, iMessage, web
              chat)
            </li>
          </ul>
          ...
          <p className="text-zinc-300 mb-8">
            OpenClaw is the foundation, and we&rsquo;ve opened community learning labs that connect
            London and the USA. Showcase agents are shared experiments—deploy in Agentbot, visit the
            London studio or the U.S. clubhouse, and swap knowledge with other operators. The more
            we collaborate, the smarter every agent gets.
          </p>
