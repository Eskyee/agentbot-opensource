...
export default function AgentbotLaunchPost() {
 ...
 <p className="text-zinc-300 mb-4">
 → <Link href="/onboard" className="text-brand-400 hover:text-brand-300">agentbot.raveculture.xyz</Link>
 </p>
 <p className="text-zinc-300 mb-4">
 → <a href="https://github.com/Eskyee/agentbot-opensource" className="text-brand-400 hover:text-brand-300">GitHub (MIT)</a>
 </p>
 <p className="text-zinc-300 mb-4">
 → <a href="https://raveculture.mintlify.app" className="text-brand-400 hover:text-brand-300">Docs</a>
 </p>
