...
export default function AgentbotLaunchPost() {
 ...
 <p className="text-zinc-300 mb-4">
 → <Link href="/onboard" className="text-orange-500 hover:text-orange-500">agentbot.sh</Link>
 </p>
 <p className="text-zinc-300 mb-4">
 → <a href="https://github.com/Eskyee/agentbot-opensource" className="text-orange-500 hover:text-orange-500">GitHub (MIT)</a>
 </p>
 <p className="text-zinc-300 mb-4">
 → <a href="https://raveculture.mintlify.app" className="text-orange-500 hover:text-orange-500">Docs</a>
 </p>
