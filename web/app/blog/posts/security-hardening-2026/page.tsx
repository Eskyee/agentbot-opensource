      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST /api/memory</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST /api/settings</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST/DELETE /api/keys</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST /api/swarms</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST/PUT /api/scheduled-tasks</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST /api/chat</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">POST /api/generate-video</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST /api/user/storage</code></p>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-2"><code className="bg-gray-800 px-2 py-1 rounded">GET/POST /api/heartbeat, /api/referral</code></p>
            <p className="text-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
              <p className="text-gray-400 text-sm">Rate Limit Protection</p>
              <p className="text-3xl font-bold text-green-400">60 req/min</p>
              <p className="text-gray-400 text-sm mt-2">Per IP address</p>
            </div>

            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
              <p className="text-gray-400 text-sm">SQL Injection Detection</p>
              <p className="text-3xl font-bold text-green-400">100%</p>
              <p className="text-gray-400 text-sm mt-2">Pattern-based detection</p>
            </div>

            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
              <p className="text-gray-400 text-sm">Bot Detection</p>
              <p className="text-3xl font-bold text-green-400">Real-time</p>
              <p className="text-gray-400 text-sm mt-2">User agent analysis</p>
            </div>

            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
              <p className="text-gray-400 text-sm">Security Headers</p>
              <p className="text-3xl font-bold text-green-400">8/8</p>
              <p className="text-gray-400 text-sm mt-2">All headers present</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-800 rounded-xl p-8 text-center mt-12">
