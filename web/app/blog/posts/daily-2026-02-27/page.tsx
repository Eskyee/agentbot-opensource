        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              <span className="text-xs px-2 py-1 rounded-full bg-zinc-800 text-zinc-400">Platform Improvements</span>
              <span className="text-xs px-2 py-1 rounded-full bg-zinc-800 text-zinc-400">OpenClaw Updates</span>
            </div>
          </div>
