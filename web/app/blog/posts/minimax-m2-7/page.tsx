...
export default function Post() {
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-4">
            The wait is over. <strong>MiniMax M2.7</strong> — the latest and most powerful model
            from MiniMax — is now available on Agentbot via OpenRouter.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            M2.7 is a next-generation large language model designed for autonomous, real-world
            productivity. It&apos;s built for <strong>agents</strong> — not just chatbots.
          </p>
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>Multi-agent collaboration</strong> — M2.7 can plan, execute, and refine
              complex tasks across dynamic environments
            </li>
            <li>
              <strong>Live debugging</strong> — Real-time error detection and fixing
            </li>
            <li>
              <strong>Financial modeling</strong> — Complex financial calculations and projections
            </li>
            <li>
              <strong>Full document generation</strong> — Word, Excel, and PowerPoint
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>Input:</strong> $0.30/M tokens
            </li>
            <li>
              <strong>Output:</strong> $1.20/M tokens
            </li>
            <li>
              <strong>Context:</strong> 204,800 tokens
            </li>
          </ul>
          ...
          <ol className="list-decimal list-inside text-zinc-300 mb-4">
            ...
            <li>
              Select <strong>MiniMax M2.7</strong> as your model
            </li>
          </ol>
 ...
 -d '{"model": "minimax/minimax-m2.7", "message": "Build me a trading bot"}'`}
          ...
          <p className="text-zinc-300 mb-4">
            M2.7 is built for <strong>autonomous agents</strong> — not just answering questions. It
            can:
          </p>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <p className="text-zinc-300 mb-4">
            This aligns perfectly with Agentbot&apos;s mission:{' '}
            <strong>autonomous agents that work while you sleep</strong>.
          </p>

          <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Get Started</h2>
          <p className="text-zinc-300 mb-4">
            <a href="https://agentbot.sh" className="text-zinc-400 hover:text-white">
              Sign up now
            </a>{' '}
            and select MiniMax M2.7 as your AI model.
          </p>
