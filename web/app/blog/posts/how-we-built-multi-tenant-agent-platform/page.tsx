    ...
    <main className="min-h-screen bg-black text-white font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-4">
            The open source repo (<a href="https://github.com/Eskyee/agentbot-opensource" className="text-orange-500 hover:text-orange-500">github.com/Eskyee/agentbot-opensource</a>) shows our architecture, CI quality, and code standards. The private repo has real features, customer data, and production infra.
          </p>
          <p className="text-zinc-300 mb-4">
          ...
          <p className="text-zinc-300 mb-4">
            → <a href="https://dev.to/agentbot/how-we-built-a-multi-tenant-ai-agent-platform-and-open-sourced-it-521g" className="text-orange-500 hover:text-orange-500" target="_blank" rel="noopener noreferrer">How We Built a Multi-Tenant AI Agent Platform (And Open-Sourced It)</a>
          </p>

          <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Links</h2>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li><strong>Live Platform:</strong> <a href="https://agentbot.sh" className="text-orange-500 hover:text-orange-500">agentbot.sh</a></li>
            <li><strong>Open Source:</strong> <a href="https://github.com/Eskyee/agentbot-opensource" className="text-orange-500 hover:text-orange-500">github.com/Eskyee/agentbot-opensource</a></li>
            <li><strong>Docs:</strong> <a href="https://raveculture.mintlify.app" className="text-orange-500 hover:text-orange-500">raveculture.mintlify.app</a></li>
          </ul>
        </article>
      </div>
    </main>
