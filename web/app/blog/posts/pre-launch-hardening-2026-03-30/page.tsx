      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-lg text-zinc-300 mb-6">
            T-minus 1 day until Agentbot launches. Last night we ran a full code audit across the
            entire provisioning pipeline. Here&apos;s what we found, what we fixed, and why your
            platform is now bulletproof.
          </p>

          <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">The Problem</h2>
          <p className="text-zinc-300 mb-4">
            Payment enforcement had gaps. The frontend provision route wasn&apos;t passing
            subscription IDs to the backend. Team provisioning had no payment gate at all — any
            authenticated user could spin up a full team for free. Agent creation was wide open.
            These weren&apos;t theoretical risks — they were live holes in production.
          </p>
          ...
          <ul className="text-zinc-300 mb-4 list-disc pl-6 space-y-3">
            <li>
              ...
              from the database and passes it to the backend. Without this, every non-admin
              provision was rejected with a 402.
            </li>
            <li>
              <strong>Team provisioning</strong> — Added authentication middleware and payment
              validation. Previously any authenticated user could provision unlimited teams without
              paying.
            </li>
            <li>
              <strong>Agent creation</strong> — Added payment gate on the{' '}
              <code className="text-xs bg-zinc-900 px-1 py-0.5 rounded">POST /agents</code>
              endpoint. Now requires an active Stripe subscription or admin role.
            </li>
            <li>
              <strong>Frontend team route</strong> — Now passes the subscription ID for every agent
              in a team. No more free rides on multi-agent provisioning.
            </li>
            <li>
              <strong>Build verification</strong> — Both backend and frontend pass{' '}
              <code className="text-xs bg-zinc-900 px-1 py-0.5 rounded">tsc --noEmit</code>
          ...
          <p className="text-zinc-300 mb-4">The full payment chain is locked down end-to-end:</p>
          ...
          <p className="text-zinc-300 mb-4">
            When Agentbot launches tomorrow, every provisioned agent is backed by a verified Stripe
            subscription. No free tier exploitation. No billing bypasses. The platform pays for
            itself from day one.
          </p>
          <p className="text-zinc-300 mb-4">
            We don&apos;t launch with gaps. We don&apos;t ship broken. Every endpoint audited, every
            payment path verified, every edge case covered. That&apos;s how you run a platform.
          </p>
