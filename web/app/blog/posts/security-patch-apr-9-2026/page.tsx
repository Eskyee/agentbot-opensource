...
export default function SecurityPatchApr92026() {
 ...
 <p className="text-zinc-500 text-sm">Fixed: <span className="text-green-400">6.1.7</span> &mdash; <a href="https://github.com/advisories/GHSA-737v-mqg7-c878" className="text-orange-400 hover:underline">GHSA-737v-mqg7-c878</a></p>
 </div>
