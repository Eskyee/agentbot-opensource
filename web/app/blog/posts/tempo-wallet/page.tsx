      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;re excited to announce <strong>Tempo Wallet</strong> support in Agentbot. Now
            your AI agents can pay for services autonomously using USDC on Base — no human
          ...
          <p className="text-zinc-300 mb-4">
            Tempo is a wallet infrastructure designed specifically for AI agents. Unlike traditional
            wallets that require human signatures, Tempo wallets can:
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            Each agent can have its own Tempo wallet. When the agent needs to pay for a service (AI
            API calls, data queries, etc.), it automatically signs and submits the payment.
          </p>
...
// No human approval needed`}
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>Budget isolation</strong> — Each agent has its own USDC balance
            </li>
            <li>
              <strong>Company control</strong> — Fund specific agents for specific tasks
            </li>
            <li>
              <strong>Audit trails</strong> — Track spending per agent
            </li>
          </ul>
...
// Returns: { address, privateKey }`}
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>AI API calls</strong> — Agents pay for GPT-4, Claude, Gemini usage
            </li>
            <li>
              <strong>Data queries</strong> — Pay for database lookups, API access
            </li>
            <li>
              <strong>Tool usage</strong> — Pay for browser automation, scraping
            </li>
            <li>
              <strong>Services</strong> — Pay for external APIs on demand
            </li>
          </ul>

          <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Get Started</h2>
          <p className="text-zinc-300 mb-4">
            Tempo Wallet is now available in Agentbot. Configure your agent&apos;s wallet via the
            API or dashboard.
          </p>
          <p className="text-zinc-300 mb-4">
            Built on <strong>x402 protocol</strong> for standardized machine-to-machine payments.
          </p>

          <div className="mt-12 pt-8 border-t border-zinc-900">
            <p className="text-zinc-500">
              Learn more:{' '}
              <a href="https://mpp.dev" className="text-zinc-400 hover:text-white">
                mpp.dev
              </a>{' '}
              |{' '}
              <a href="https://wallet.tempo.xyz" className="text-zinc-400 hover:text-white">
                wallet.tempo.xyz
              </a>
            </p>
          </div>
