    ...
    <main className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">The 9-Year Signal</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What We&apos;ve Shipped</h2>
          
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">A++ Multi-Tenancy</h3>
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Zero Vulnerabilities</h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Autonomous Wallets</h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">OpenClaw 2026.3.13</h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">baseFM: The Station</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">The Developer Pedigree</h2>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Join the Frequency</h2>
