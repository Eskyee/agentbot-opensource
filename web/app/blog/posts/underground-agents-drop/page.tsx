...
export default function Post() {
 ...
 <div className="bg-zinc-950 p-4 mb-6">
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">New: Community Treasury Agent</h2>
 <p className="text-zinc-300 mb-4">
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">New: Crypto Wallet Integration</h2>
 <p className="text-zinc-300 mb-4">
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">UI/UX Improvements</h2>
 
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Mobile Menu</h3>
 <ul className="list-disc list-inside text-zinc-300 mb-4 space-y-2">
 ...
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Dashboard Sidebar</h3>
 <ul className="list-disc list-inside text-zinc-300 mb-4 space-y-2">
 ...
 <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Kimi K2.5 Positioning</h2>
 <p className="text-zinc-300 mb-4">
 ...
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Phase 1 (This Week)</h3>
 <ul className="list-disc list-inside text-zinc-300 mb-4 space-y-2">
 ...
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Phase 2 (Next Month)</h3>
 <ul className="list-disc list-inside text-zinc-300 mb-4 space-y-2">
 ...
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Phase 3 (3 Months)</h3>
 <ul className="list-disc list-inside text-zinc-300 mb-4 space-y-2">
 <li>Public launch</li>
