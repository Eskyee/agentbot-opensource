    ...
    <main className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Dark Mode UI Refresh</h2>
          <p className="text-zinc-300 mb-4">
            Complete redesign with Geist Design System. Cleaner typography, better contrast, and refined shadows throughout.
          </p>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Stripe Checkout Flow</h2>
          <p className="text-zinc-300 mb-4">
            Seamless payment integration for credit purchases. Buy credits with card, Apple Pay, or Google Pay.
          </p>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">OAuth with Google & GitHub</h2>
          <p className="text-zinc-300 mb-4">
            Sign up in one click. No password required. Secure authentication via NextAuth.js.
          </p>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Resend Email Integration</h2>
          <p className="text-zinc-300 mb-4">
            Welcome emails, password resets, and deployment notifications now sent via Resend.
          </p>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Bug Fixes</h2>
