    ...
    <main className="min-h-screen bg-black text-white font-mono">
      <article className="max-w-3xl mx-auto px-6 py-16">
        <header className="mb-12">
          <div className="text-[10px] uppercase tracking-widest text-orange-400 mb-4">Release</div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-6 my-8">
            <h3 className="text-sm font-bold uppercase tracking-wider text-orange-400 mb-4">What's New</h3>
          ...
          <p className="text-zinc-500 text-sm">
            For self-hosting, pull the latest image: <code className="text-orange-400">ghcr.io/openclaw/openclaw:2026.4.7</code>
          </p>
        </div>
      </article>
    </main>
