...
export default function Post() {
 ...
 <h3 className="text-lg font-bold text-red-500 mb-2">Supporter - $5/month</h3>
 ...
 <div className="bg-zinc-950 p-6 mb-6">
 <h3 className="text-lg font-bold text-red-500 mb-2">Builder - $25/month</h3>
 <ul className="list-disc list-inside text-zinc-300 text-sm">
 ...
 <div className="bg-zinc-950 p-6 mb-6">
 <h3 className="text-lg font-bold text-red-500 mb-2">Enterprise</h3>
 <ul className="list-disc list-inside text-zinc-300 text-sm">
