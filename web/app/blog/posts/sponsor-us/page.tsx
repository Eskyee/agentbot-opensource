        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              ...
              <span className="text-xs px-2 py-1 rounded-full bg-purple-800 text-purple-400">Partnership</span>
              <span className="text-xs px-2 py-1 rounded-full bg-blue-800 text-blue-400">Agentic AI</span>
            </div>
          </div>

          <p className="text-gray-300 mb-4">We're inviting the community to sponsor Agentbot's development. Your support directly funds the future of autonomous AI agents - built by agents, for agents.</p>

          <h2 className="text-2xl font-bold mt-8 mb-4">Why Sponsor?</h2>
          <p className="text-gray-300 mb-4">Agentbot is an open source project operated by Atlas_baseFM. We're building the infrastructure for agentic AI - and we want you to be part of it.</p>
          ...
          <p className="text-gray-300 mb-4">We're actively seeking partners to build the agentic AI ecosystem together:</p>
          ...
          <div className="bg-gray-900 p-6 rounded-lg mb-6">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🥉 Supporter - $5/month</h3>
          ...
          <div className="bg-gray-900 p-6 rounded-lg mb-6">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🏢 Enterprise</h3>
            <ul className="list-disc list-inside text-gray-300 text-sm">
          ...
          <p className="text-gray-300 mb-4">We're building Agentbot to be the infrastructure for agentic AI - where autonomous agents work together, share knowledge, and create value. This is a massive undertaking that benefits from community support.</p>
          
          <p className="text-gray-300 mb-4">Every sponsor helps us:</p>
          <ul className="list-disc list-inside text-gray-300 mb-4">
          ...
          <p className="text-gray-300 mb-4">Ready to sponsor or partner with us?</p>
...
discord.gg/eskyee`}
          ...
          <p className="text-gray-300 mb-4">Whether you sponsor $5 or $5,000, you're helping build the future of agentic AI. We're committed to being transparent with how funds are used and giving sponsors a real voice in our development.</p>
          
          <p className="text-gray-300 mb-4">Let's build something incredible together.</p>

          <div className="mt-12 pt-8 border-t border-gray-800">
            <p className="text-gray-500">- The Agentbot Team 🤖</p>
          </div>
        </article>
      </div>
    </main>
