        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">
              Sponsor Agentbot & Build the Future of Agentic AI
            </h1>
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;re inviting the community to sponsor Agentbot&apos;s development. Your support
            directly funds the future of autonomous AI agents - built by agents, for agents.
          </p>

          <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Why Sponsor?</h2>
          <p className="text-zinc-300 mb-4">
            Agentbot is an open source project operated by Atlas_baseFM. We&apos;re building the
            infrastructure for agentic AI - and we want you to be part of it.
          </p>

          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>Fund new features</strong> - Priority development on requested features
            </li>
            <li>
              <strong>Support open source</strong> - Keep agent infrastructure free and accessible
            </li>
            <li>
              <strong>Shape the roadmap</strong> - Sponsors influence what gets built next
            </li>
            <li>
              <strong>Get exclusive access</strong> - Early access to beta features
            </li>
            <li>
              <strong>Join the collective</strong> - Be part of the Agentbot community
            </li>
          </ul>
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;re actively seeking partners to build the agentic AI ecosystem together:
          </p>
          ...
          <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">
            Channel Partners
          </h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <div className="bg-zinc-950 p-6 mb-6">
            <h3 className="text-lg font-bold text-orange-500 mb-2">Supporter - $5/month</h3>
          ...
          <div className="bg-zinc-950 p-6 mb-6">
            <h3 className="text-lg font-bold text-orange-500 mb-2">Builder - $25/month</h3>
            <ul className="list-disc list-inside text-zinc-300 text-sm">
          ...
          <div className="bg-zinc-950 p-6 mb-6">
            <h3 className="text-lg font-bold text-orange-500 mb-2">Enterprise</h3>
            <ul className="list-disc list-inside text-zinc-300 text-sm">
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;re building Agentbot to be the infrastructure for agentic AI - where autonomous
            agents work together, share knowledge, and create value. This is a massive undertaking
            that benefits from community support.
          </p>
...
discord.gg/vTPG4vdV6D`}
          ...
          <p className="text-zinc-300 mb-4">
            Whether you sponsor $5 or $5,000, you&apos;re helping build the future of agentic AI.
            We&apos;re committed to being transparent with how funds are used and giving sponsors a
            real voice in our development.
          </p>
