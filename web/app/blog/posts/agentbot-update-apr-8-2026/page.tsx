    ...
    <main className="min-h-screen bg-black text-white font-mono">
      <article className="max-w-3xl mx-auto px-6 py-16">
        <header className="mb-12">
          <div className="text-[10px] uppercase tracking-widest text-red-500 mb-4">Update</div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-zinc-400 mb-6">
            <a href="https://agentbot.sh/token" className="text-red-500 hover:underline">View the token page →</a> now lists both the Base ($AGENTBOT on Uniswap) and Solana (pump.fun) tokens.
          </p>
