  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="mb-8">
        ...
        <p className="text-zinc-400">{metadata.date}</p>
      </div>
      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-4 my-8">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            ...
            <div className="text-3xl font-black mb-2">£19<span className="text-lg font-normal text-zinc-400">/mo</span></div>
          ...
          <div className="bg-zinc-900 border border-blue-500/30 rounded-xl p-6">
            ...
            <div className="text-3xl font-black mb-2">£49<span className="text-lg font-normal text-zinc-400">/mo</span></div>
            <p className="text-sm text-zinc-400">3 agents, 20 releases, auto-trigger</p>
          </div>
          <div className="bg-zinc-900 border border-blue-500/30 rounded-xl p-6">
            <h3 className="font-bold text-white mb-2">Label</h3>
            <div className="text-3xl font-black mb-2">£149<span className="text-lg font-normal text-zinc-400">/mo</span></div>
          ...
          <div className="bg-zinc-900 border border-orange-500/30 rounded-xl p-6">
            ...
            <div className="text-3xl font-black mb-2">£399<span className="text-lg font-normal text-zinc-400">/mo</span></div>
