...
export const metadata = {
  ...
  date: '18 March 2026',
  excerpt:
    'Reprtoir calculates your splits. We execute them instantly. Welcome to the autonomous payment layer the music industry has been waiting for.',
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">
            Introducing RoyaltyBot: Instant Payment Layer for Music
          </h1>
        ...
        <article className="prose prose-invert max-w-none">
          <p className="text-lg text-zinc-300 leading-relaxed mb-8">
            <span className="text-zinc-300 font-bold">Reprtoir calculates your splits.</span> We
            execute them instantly. Welcome to the autonomous payment layer the music industry has
            been waiting for.
          </p>

          <h2 className="text-xl font-bold uppercase tracking-tighter mt-12 mb-4">
            The Problem: Royalty Payments Are Broken
          </h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            Here&apos;s how royalty payments work today: DSPs calculate your streaming revenue →
            send to distributor → distributor calculates your split → 60-90 days later, it hits your
            bank account. And that&apos;s if you&apos;re lucky.
          </p>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            For independent artists working with producers, labels, or collectives? The math gets
            messy, transparency is a myth, and waiting 3 months for money you earned today is
            unacceptable in 2026.
          </p>

          <h2 className="text-xl font-bold uppercase tracking-tighter mt-12 mb-4">
            Our Solution: RoyaltyBot
          </h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          <h2 className="text-xl font-bold uppercase tracking-tighter mt-12 mb-4">
            Not Just Streaming: Booking Payments Too
          </h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            We&apos;ve also launched the{' '}
            <span className="text-zinc-300 font-bold">Booking Settlement Agent</span>. It handles:
          </p>
          <ul className="list-disc list-inside text-zinc-400 text-sm space-y-2 mb-6">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            Because it&apos;s the only way to do instant, verifiable, self-custody payments. No bank
            delays. No middlemen. No &quot;approaching real-time&quot; promises. Artists own their
            wallets, agents execute the splits, and money moves in seconds.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px my-8 border border-zinc-800">
            <div className="bg-zinc-950/50 border border-zinc-800 p-6">
              ...
              <div className="text-3xl font-bold mb-2">
                £19<span className="text-lg font-normal text-zinc-400">/mo</span>
              </div>
            ...
            <div className="bg-zinc-950/50 border border-zinc-800 p-6">
              ...
              <div className="text-3xl font-bold mb-2">
                £49<span className="text-lg font-normal text-zinc-400">/mo</span>
              </div>
            ...
            <div className="bg-zinc-950/50 border border-zinc-800 p-6">
              ...
              <div className="text-3xl font-bold mb-2">
                £399<span className="text-lg font-normal text-zinc-400">/mo</span>
              </div>
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            We&apos;re not replacing the accounting tools like Reprtoir. We&apos;re becoming the
            payment layer that makes their output actually reach artists&apos; wallets. They do
            calculation. We do execution.
          </p>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            This is where our Base + CDP + A2A stack creates a moat nobody else has. Autonomous
            agents that negotiate, calculate, and execute payments — without a single human in the
            loop.
          </p>
