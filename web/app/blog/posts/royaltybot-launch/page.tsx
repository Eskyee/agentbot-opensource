    ...
    <main className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono px-6 py-16 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-12 mb-4">The Problem: Royalty Payments Are Broken</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-12 mb-4">Our Solution: RoyaltyBot</h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 p-6 my-8">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-12 mb-4">Not Just Streaming: Booking Payments Too</h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-12 mb-4">Why USDC on Base?</h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-12 mb-4">Pricing</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px my-8 border border-zinc-800">
            <div className="bg-zinc-900/50 border-zinc-800 p-6">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-12 mb-4">The Bigger Picture</h2>
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
