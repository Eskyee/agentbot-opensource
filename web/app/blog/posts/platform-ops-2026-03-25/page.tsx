        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">
              Platform Ops: Dashboard Overhaul & Infrastructure Hardening
            </h1>
          ...
          <p className="text-lg text-zinc-300 mb-6">
            Late-night platform session. Here&apos;s what shipped, what we fixed, and where
            we&apos;re headed.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            Every dashboard page now shares a unified sidebar and top navbar. Settings and billing
            pages redesigned with consistent branding — Geist typography, zinc borders, uppercase
            tracking. One layout file wraps 30+ sub-pages automatically. Clean, fast, on-brand.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            OAuth consent screen and redirect URIs configured for Google Calendar integration. Users
            can now sync their Google Calendar with Agentbot for automated scheduling and
          ...
          <p className="text-zinc-300 mb-4">
            Completed a comprehensive audit of all services: Vercel frontend, Render backend (API,
            web, worker, Redis, Postgres), Railway x402 gateway, and Upstash Redis. All core
            services healthy. Zero critical vulnerabilities. Encrypted env vars verified. No secret
            leakage detected.
          </p>
