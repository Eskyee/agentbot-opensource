...
export const metadata = {
  ...
  description:
    'How we integrated Base ecosystem tools — Builder Codes for onchain attribution, CDP Paymaster for gasless NFT minting, and CDP Trade API for token swaps — all in one session.',
  openGraph: {
    title: 'Agentbot Goes Onchain: Builder Codes, NFT Wristbands, and Token Swaps',
    description:
      'Builder Codes for attribution. NFT wristbands for community access. Token swaps via CDP. Everything we built in one night.',
  },
};
    ...
    <main className="min-h-screen bg-black text-white font-mono">
      <article className="max-w-3xl mx-auto px-5 sm:px-6 py-24 sm:py-36">
        ...
        <div className="mb-12">
          ...
          <p className="text-zinc-500 text-sm mt-6">June 5, 2026 · 12 min read</p>
        </div>
        ...
        <div className="space-y-8 text-zinc-300 text-sm leading-relaxed">
          <p>
            ...
            <strong className="text-white"> token swaps</strong> via the CDP Trade API. Here's what
            we built and how it works.
          </p>
          ...
          <p>
            A Builder Code is a unique string (e.g.{' '}
            <code className="text-orange-500">bc_4k0319ta</code>) that gets encoded into the last
            bytes of your transaction data. Smart contracts ignore the suffix — it's extracted by
            offchain indexers after the fact. Gas overhead is minimal (16 gas per non-zero byte).
          </p>

          <h3 className="text-lg font-bold text-white">Our Implementation</h3>
          <p>
            We integrated Builder Codes at the{' '}
            <strong className="text-white">wagmi config level</strong>, meaning every transaction
            from Agentbot automatically includes the attribution. Here's the setup:
          </p>
...
export const wagmiConfig = createConfig({
  ...
  dataSuffix: DATA_SUFFIX,  // Every tx includes this
          ...
          <p>
            The critical fix was ensuring <code className="text-orange-500">WalletProvider</code>{' '}
            imports this config instead of creating its own. Without this, the{' '}
            <code className="text-orange-500">dataSuffix</code> was dead code — transactions went
            out unattributed.
          </p>
          ...
          <div className="border-l-2 border-orange-500 pl-6 mt-12">
            ...
            <p>
              The Digital Wristband is an ERC-721 NFT on Base that grants lifetime access to baseFM
              streams, token-gated community channels, and exclusive artist drops.
            </p>
          </div>

          <h3 className="text-lg font-bold text-white">The Flow</h3>
          <p>
            Users visit <code className="text-orange-500">agentbot.sh/wristband</code> and see one
            of three states:
          </p>
          ...
          <p>The component detects wallet connections through multiple layers:</p>
          <ul className="list-disc list-inside space-y-1 text-zinc-400 ml-4">
            <li>
              <strong className="text-zinc-300">wagmi hooks</strong> —{' '}
              <code className="text-orange-500">useAccount()</code> for managed connections
            </li>
            <li>
              <strong className="text-zinc-300">window.ethereum</strong> — fallback detection for
              any EVM wallet
            </li>
            <li>
              <strong className="text-zinc-300">useCustomSession</strong> — email auth state from
              NextAuth
            </li>
          </ul>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            ...
            <p className="text-zinc-400 text-xs">
              The example contract <code className="text-orange-500">0x66519F...D49</code> from CDP
              docs doesn't exist on Base mainnet. You need to deploy your own ERC-721 contract. We
              recommend Remix IDE for fastest deployment.
            </p>
          </div>
          ...
          <ol className="list-decimal list-inside space-y-2 text-zinc-400 ml-4">
            ...
            <li>
              <strong className="text-zinc-300">Review</strong> the quote (rate, price impact,
              slippage)
            </li>
            <li>
          ...
          <p>The swap flow uses a two-step process:</p>
...
{ action: "swap", fromToken, toToken, fromAmount, walletAddress }`}</code>
          ...
          <p>
            ...
            quote generation and execution. Slippage protection is built in (1% default). Every swap
            includes Builder Code attribution automatically.
          </p>
          ...
          <div className="border-l-2 border-orange-500 pl-6 mt-12">
            ...
            <p>
              The Bridge connects your local OpenClaw instance to Agentbot, letting you chat with
              your AI from any device — phone, tablet, another computer.
            </p>
          </div>
          ...
          <p>
            The bridge client polls the server every 3 seconds, receives requests, runs them through
            your local OpenClaw, and sends responses back. Your data stays on your machine.
          </p>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-zinc-500 text-xs">
                  The CDP example contract doesn't exist on mainnet. Deploy via Remix IDE or
                  thirdweb.
                </p>
              </div>
            </li>
