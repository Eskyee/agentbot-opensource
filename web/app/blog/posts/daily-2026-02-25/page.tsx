...
export default function Post() {
 ...
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Recent Commits</h3>
 ...
 <h3 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Documentation Updates</h3>
 <p className="text-zinc-300 mb-4">
