    ...
    <main className="min-h-screen bg-black text-white font-mono">
      <article className="max-w-3xl mx-auto px-6 py-16">
        <header className="mb-12">
          <div className="text-[10px] uppercase tracking-widest text-red-500 mb-4">Security</div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-6 my-8">
            <h3 className="text-sm font-bold uppercase tracking-wider text-red-500 mb-4">Key Findings</h3>
          ...
          <p className="text-zinc-400 mb-6">
            <span className="text-red-500 font-bold">Project Glasswing</span> is an important step toward giving defenders a durable advantage in the coming AI-driven era of cybersecurity. Major partners including Cisco, AWS, Microsoft, CrowdStrike, Google, Palo Alto Networks, and JPMorganChase are participating.
          </p>
          ...
          <div className="border-t border-zinc-800 pt-8 mt-12">
            <p className="text-zinc-500 text-sm">
              This post synthesizes findings from Anthropic's Project Glasswing announcement. For technical details, see the <a href="https://www.anthropic.com/engineering" target="_blank" rel="noopener" className="text-red-500 hover:underline">Anthropic Frontier Red Team blog</a>.
            </p>
          </div>
        </div>
      </article>
