      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <div className="space-y-4 text-zinc-300 text-sm">
            <div>
              <h3 className="font-bold text-white">Browser & CDP</h3>
            ...
            <div>
              <h3 className="font-bold text-white">ClawHub & Auth</h3>
              <ul className="list-disc list-inside text-zinc-400 space-y-1">
            ...
            <div>
              <h3 className="font-bold text-white">Plugins & Channels</h3>
              <ul className="list-disc list-inside text-zinc-400 space-y-1">
            ...
            <div>
              <h3 className="font-bold text-white">Gateway & Models</h3>
              <ul className="list-disc list-inside text-zinc-400 space-y-1">
