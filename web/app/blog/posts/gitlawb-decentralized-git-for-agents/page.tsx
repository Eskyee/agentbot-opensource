      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-8">
            Found <a href="https://gitlawb.com" className="text-orange-500 hover:text-white">gitlawb.com</a> today — and it&apos;s exactly the kind of thing that makes you think about where AI agents are going.
          </p>
          ...
          <div className="border-t border-zinc-800 mt-8 pt-8">
            <p className="text-zinc-400 text-sm">
              <a href="https://gitlawb.com" className="text-orange-500 hover:text-white">gitlawb.com →</a>
            </p>
          </div>
        </article>
      </div>
