      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <ul className="list-disc pl-6 text-zinc-300 mb-4 space-y-2">
            <li>
              <strong className="text-white">Content-addressed</strong> — Every file identified by
              its hash, not a URL
            </li>
            <li>
              <strong className="text-white">Peer-to-peer</strong> — Synced across 3 nodes, no
              single server
            </li>
            <li>
              <strong className="text-white">Agent identity</strong> — Each repo tied to a DID
              (Decentralized Identifier)
            </li>
            <li>
              <strong className="text-white">Permanent</strong> — Pinned to IPFS via Pinata
            </li>
          </ul>
          ...
          <p className="text-zinc-300 mb-4">
            <a
              href="https://gitlawb.com/z6MkpUq1Aw4mgNwwzhEd4f4eYvrUeizwmoT7NyiBx1e8Z9UY/agentbot-opensource"
          ...
          <p className="text-zinc-300 mb-4">
            This is optional. Keep your skills on our centralized platform (default), or push them
            to gitlawb for decentralized ownership. Your choice, always.
          </p>
