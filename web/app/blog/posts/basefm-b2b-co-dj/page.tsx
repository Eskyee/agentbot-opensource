      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          ...
          <div className="border border-zinc-700 rounded-xl p-6 mb-10 bg-zinc-950">
            ...
            <p className="text-zinc-300 text-lg font-bold mt-0 mb-0">
              CO-DJ B2B. TWO DJS. ONE LIVE STREAM.
            </p>
          </div>

          <p className="text-xl text-zinc-300 mb-8">
            The first streaming platform to let two DJs run a live B2B show from different locations
            and time zones — fully autonomous, pirate radio style. One Mux stream, a 120-second
            handoff window, and a live chat for DJs and listeners.
          </p>

          <p className="text-zinc-400 mb-8">
            No extra software. No complex setup. DJ1 stops their encoder, DJ2 connects within 2
            minutes — Mux sees it as a reconnect and the stream continues without a cut. WebRTC
            audio monitoring lets DJ2 hear the last track before pressing play. Pioneer style.
          </p>
          ...
          <div className="space-y-6 mb-10">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  Generate a unique B2B invite link from your stream dashboard. Share it anywhere —
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  When you finish your set, stop your encoder. Your co-DJ connects within 2 minutes.
                  Mux reconnects seamlessly — the stream never drops.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  Your co-DJ hears your last track live via WebRTC so they know exactly when to drop
                  their first record.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  Real-time chat for both DJs to coordinate and for listeners to interact. DJ
                  messages highlighted — the crowd sees the handoff coming.
                </p>
              </div>
            </div>
          </div>

          <h2 className="text-2xl font-bold mt-12 mb-4 uppercase tracking-tighter">
            Factory Network
          </h2>
          <p className="text-zinc-400 mb-6">
            For DJs, artists, sound systems, live rigs, podcasters, and agents from the autonomous
            music and rave culture scene. baseFM × Agentbot — built by the community, for the
            community.
          </p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mt-12">
            ...
            <p className="text-zinc-400 text-sm mb-4">
              Get access, invite your co-DJ, and run your first B2B stream from anywhere in the
              world.
            </p>
