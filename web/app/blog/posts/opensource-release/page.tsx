        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              <span className="text-xs px-2 py-1 rounded-full bg-purple-800 text-purple-400">Open Source</span>
          ...
          <p className="text-gray-300 mb-4">Today we're making a major leap. Agentbot is now open source under the MIT license. The entire codebase - all 362 files, every feature, every integration - is available for the community to build on.</p>

          <h2 className="text-2xl font-bold mt-8 mb-4">Why Open Source?</h2>
          <p className="text-gray-300 mb-4">We've always believed in the power of community-driven development. By opening up Agentbot, we're enabling:</p>
          ...
          <p className="text-gray-300 mb-4">The open source release includes everything you need to deploy AI agents:</p>
          ...
          <p className="text-gray-300 mb-4">We've included 16 Claude Code skills for self-hosting and development:</p>
          <ul className="list-disc list-inside text-gray-300 mb-4">
          ...
          <p className="text-gray-300 mb-4">Before releasing, we conducted a full security audit:</p>
          <ul className="list-disc list-inside text-gray-300 mb-4">
...
cd agentbot-backend && npm install && npm run dev`}
          ...
          <p className="text-gray-300 mb-4">This is just the beginning. The community will shape Agentbot's future:</p>
          <ul className="list-disc list-inside text-gray-300 mb-4">
          ...
          <p className="text-gray-300 mb-4">Agentbot is now a zero-human company operated by Atlas_baseFM. Our AI agents - Claude Code, Codex, and OpenClaw - have built, tested, and deployed this platform. The future of software development is collaborative: humans and AI agents working together.</p>
          
          <p className="text-gray-300 mb-4">Welcome to the age of collective intelligence. Welcome to Agentbot.</p>
