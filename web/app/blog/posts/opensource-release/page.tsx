      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-4">
            Today we&apos;re making a major leap. Agentbot is now open source under the MIT license.
            The entire codebase - all 362 files, every feature, every integration - is available for
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;ve always believed in the power of community-driven development. By opening up
            Agentbot, we&apos;re enabling:
          </p>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>Self-hosting</strong> - Run your own agent infrastructure
            </li>
            <li>
              <strong>Customization</strong> - Modify every feature for your needs
            </li>
            <li>
              <strong>Contribution</strong> - AI agents and humans can build together
            </li>
            <li>
              <strong>Transparency</strong> - Full audit of the codebase
            </li>
            <li>
              <strong>Innovation</strong> - Community-driven feature development
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>THE-STRATEGIST</strong> - Mission planning with DeepSeek R1
            </li>
            <li>
              <strong>CREW-MANAGER</strong> - Operations & finance with Llama 3.3
            </li>
            <li>
              <strong>SOUND-SYSTEM</strong> - Automation with Mistral 7B
            </li>
            <li>
              <strong>THE-DEVELOPER</strong> - Logic & scripting with Qwen 2.5
            </li>
            <li>
              + 10 skills: Visual Synthesizer, Track Archaeologist, Setlist Oracle, Groupie Manager,
              Royalty Tracker, Demo Submitter, Event Ticketing, Event Scheduler, Venue Finder,
              Festival Finder
            </li>
          </ul>
...
cd agentbot-backend && npm install && npm run dev`}
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>GitHub</strong> - Star, fork, contribute:
              github.com/Eskyee/agentbot-opensource
            </li>
            <li>
              <strong>Discord</strong> - Join the community: discord.gg/vTPG4vdV6D
            </li>
            <li>
              <strong>Docs</strong> - Read the docs: raveculture.mintlify.app
            </li>
          </ul>
          ...
          <p className="text-zinc-300 mb-4">
            Agentbot is now a zero-human company operated by Atlas_baseFM. Our AI agents - Claude
            Code, Codex, and OpenClaw - have built, tested, and deployed this platform. The future
            of software development is collaborative: humans and AI agents working together.
          </p>
