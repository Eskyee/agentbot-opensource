...
docker compose -f docker-compose.headless.yml up -d`}
          ...
          <div className="mt-8 p-4 border border-zinc-800">
            <p className="text-zinc-400 text-sm">
              ...
              <a href="https://github.com/EskyLab/btcpayagentbot-docker" className="text-orange-500 hover:underline">GitHub</a> &middot;{' '}
              <a href="https://raveculture.mintlify.app/payments/btcpay" className="text-orange-500 hover:underline">Docs</a> &middot;{' '}
              <a href="https://docs.btcpayserver.org" className="text-orange-500 hover:underline">BTCPay Server</a>
            </p>
          </div>
        </article>
      </div>
