        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">
              BotID: Invisible Protection for AI Agents
            </h1>
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;ve added Vercel BotID to protect our platform from automated attacks.
          ...
          <p className="text-zinc-300 mb-4">
            Modern bots aren&apos;t the slow, obvious crawlers of the past. They:
          </p>
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>/api/register</strong> — Prevents fake account creation
            </li>
            <li>
              <strong>/api/auth/*</strong> — Blocks brute force attacks
            </li>
            <li>
              <strong>/api/stripe/*</strong> — Protects payment endpoints
            </li>
            <li>
              <strong>/api/agents/*</strong> — Stops resource abuse
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-zinc-300 mb-4">
            <li>
              <strong>Credential stuffing</strong> — Testing stolen passwords
            </li>
            <li>
              <strong>API abuse</strong> — Draining your AI credits
            </li>
            <li>
              <strong>Fake accounts</strong> — Free tier exploitation
            </li>
            <li>
              <strong>Content scraping</strong> — Stealing your training data
            </li>
          </ul>
          ...
          <p className="text-zinc-300 mb-4">
            We&apos;ve always prioritized security. BotID is just another layer in our
