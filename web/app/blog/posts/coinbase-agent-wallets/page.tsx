      ...
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-4">
            Agentbot now supports <strong>Coinbase Developer Platform (CDP)</strong> wallets. Give
            your AI agents their own on-chain identity with full wallet capabilities on Base.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            Traditional wallets require human approval for every transaction. Agentic wallets are
            controlled by AI agents that can:
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            Agents can execute trades based on signals, market conditions, or user commands —
          ...
          <p className="text-zinc-300 mb-4">
            Automatically split and send royalties to artists, collaborators, and labels after each
            sale or stream.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            Sell tickets with automatic settlement. No payment processing fees, just pure USDC on
            Base.
          </p>
          ...
          <p className="text-zinc-300 mb-4">
            Charge users monthly in USDC. Agents handle recurring payments autonomously.
          </p>

          <h2 className="text-xl font-bold tracking-tighter uppercase mt-8 mb-4">Get Started</h2>
          <p className="text-zinc-300 mb-4">
            Coinbase CDP wallets are now available in Agentbot. Configure via:
          </p>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <div className="mt-12 pt-8 border-t border-zinc-900">
            <p className="text-zinc-500">
              Powered by{' '}
              <a href="https://cdc.coinbase.com" className="text-zinc-400 hover:text-white">
