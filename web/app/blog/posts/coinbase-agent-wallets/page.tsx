    ...
    <main className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What are Agentic Wallets?</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Why Coinbase CDP?</h2>
          
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Enterprise-Grade Security</h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Base Network Native</h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Full EVM Compatibility</h3>
          <ul className="list-disc list-inside text-zinc-300 mb-4">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Agent Capabilities</h2>
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Autonomous Trading</h3>
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Royalty Payments</h3>
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Event Ticketing</h3>
          ...
          <h3 className="text-xl font-bold uppercase tracking-tighter mt-6 mb-3">Subscription Billing</h3>
