        ...
        <article className="prose prose-invert max-w-none">
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              ...
              <span className="text-xs px-2 py-1 rounded-full bg-blue-800 text-blue-400">CDP</span>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-zinc-800">
            <p className="text-zinc-500">Powered by <a href="https://cdc.coinbase.com" className="text-blue-400 hover:underline">Coinbase Developer Platform</a></p>
          </div>
        </article>
      </div>
    </main>
