    ...
    <main className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What Are Webhooks?</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Common Use Cases</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Setting Up Webhooks</h2>
          <p className="text-zinc-300 mb-4">
            Add webhook URLs in your agent settings. We&apos;ll POST JSON data to your endpoint on each message.
          </p>

          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">API Integrations</h2>
          <p className="text-zinc-300 mb-4">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">Example: Slack Integration</h2>
          <p className="text-zinc-300 mb-4">
