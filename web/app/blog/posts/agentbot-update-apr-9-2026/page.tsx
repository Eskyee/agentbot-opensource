...
export const metadata: Metadata = {
  ...
  description:
    'New features: Solana Agent Kit integration, Blockchain Buddies digital pets, Liquid Wallet Kit (LWK) docs, and more.',
  openGraph: {
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          <p className="text-xl text-zinc-300 mb-8">
            Big updates from the lab. We've added Solana integration, digital pets for your agent,
            and full Liquid Wallet Kit documentation. Let's go.
          </p>

          <h2 className="text-2xl font-bold mt-12 mb-4">Solana Integration</h2>
          <p className="text-zinc-400 mb-4">
            Your Agentbot now connects to Solana. Trade tokens, deploy NFTs, and access 60+ MCP
            tools via Solana Agent Kit.
          </p>
          ...
          <a href="/solana" className="text-orange-500 hover:underline mb-8 block">
            View Solana integrations →
          </a>

          <h2 className="text-2xl font-bold mt-12 mb-4">Blockchain Buddies 🦀🤖👻🐉👽</h2>
          <p className="text-zinc-400 mb-4">
            Your agent now has digital companions. Hatch, feed, and play with blockchain buddies -
            stored in your database with full auth.
          </p>
          <ul className="list-disc list-inside text-zinc-400 mb-6 space-y-2">
          ...
          <a href="/buddies" className="text-orange-500 hover:underline mb-8 block">
            Meet your buddies →
          </a>

          <h2 className="text-2xl font-bold mt-12 mb-4">Liquid Wallet Kit Docs</h2>
          <p className="text-zinc-400 mb-4">
            New documentation for deploying Blockstream's Liquid Wallet Kit on Railway with Jade HWW
            support.
          </p>
          <ul className="list-disc list-inside text-zinc-400 mb-6 space-y-2">
          ...
          <a href="/docs/liquid-lwk-railway" className="text-orange-500 hover:underline mb-8 block">
            Read the guide →
          </a>
