    ...
    <main className="min-h-screen bg-black text-white font-mono">
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          ...
          <a href="/solana" className="text-orange-400 hover:underline mb-8 block">View Solana integrations →</a>
          ...
          <a href="/buddies" className="text-orange-400 hover:underline mb-8 block">Meet your buddies →</a>
          ...
          <a href="/docs/liquid-lwk-railway" className="text-orange-400 hover:underline mb-8 block">Read the guide →</a>
