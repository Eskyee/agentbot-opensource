    ...
    <main className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What&apos;s New</h2>
          
          <div className="grid gap-4 mb-6">
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-2">🔌 Gateway OpenAI Compatibility</h3>
            ...
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-2">🔒 Security: Media Dispatch Fix</h3>
              <p className="text-zinc-400 text-sm">
            ...
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-2">🐳 CLI Container Support</h3>
              <p className="text-zinc-400 text-sm">
            ...
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-2">📡 Channel Isolation</h3>
              <p className="text-zinc-400 text-sm">
            ...
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-2">🔄 Restart Recovery</h3>
              <p className="text-zinc-400 text-sm">
            ...
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-2">🧠 Skills Install Metadata</h3>
              <p className="text-zinc-400 text-sm">
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What We Updated</h2>
          ...
          <h2 className="text-2xl font-bold uppercase tracking-tighter mt-8 mb-4">What This Means for You</h2>
          ...
          <div className="mt-12 p-6 rounded-xl bg-zinc-900 border border-zinc-800">
            ...
            <div className="flex gap-3">
              ...
              <Link href="https://github.com/openclaw/openclaw/releases/tag/v2026.3.24" className="inline-block bg-zinc-800 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-zinc-700 transition-colors">
                Full Release Notes
              </Link>
            </div>
          </div>
