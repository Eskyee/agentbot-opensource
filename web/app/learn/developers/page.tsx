  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: 'Agentbot SDK',
        description:
          'Official SDK kit for building against Agentbot services and managed runtime flows.',
      ...
      },
      {
        ...
        description:
          'Use the Gitlawb Network operator surface in Agentbot, browse the decentralized mirror, and clone via DID.',
      ...
      },
      {
        ...
        description:
          'Understand Mission Control, missing skill dependencies, runtime setup, and the DJ workflow without getting lost in operator details.',
      ...
      },
      {
        ...
        description:
          'Set up X account publishing, signals, drafts, approvals, and the realistic X Live relay path for your agents.',
      ...
      },
      {
        ...
        description:
          'Official Mux Assets API docs for replay retention, archive cleanup, and post-broadcast asset management.',
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
                ...
                >
                  <div className="flex flex-wrap gap-1 mb-3">
                    {item.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[9px] uppercase tracking-widest text-zinc-600 border border-zinc-900 px-1.5 py-0.5"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        <section className="mb-16">
          ...
          <div className="border border-zinc-800 overflow-hidden">
            {apiEndpoints.map((ep, i) => (
              <div
                key={ep.path}
                className={`flex items-center gap-4 p-4 ${i > 0 ? 'border-t border-zinc-900' : ''}`}
              >
                <span
                  className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 flex-shrink-0 ${
                    ep.method === 'POST'
          ...
          <div className="grid gap-px bg-zinc-900 md:grid-cols-2">
            {codeExamples.map((example) => (
              <div key={example.title} className="bg-black p-6">
                ...
                <pre className="text-[11px] text-zinc-500 overflow-x-auto leading-relaxed">
                  {example.code}
                </pre>
              </div>
            ))}
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-px bg-zinc-900 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { label: 'Runtime', value: 'OpenClaw 2026.4.26' },
