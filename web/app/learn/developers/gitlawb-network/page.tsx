  ...
  return (
    <main className="min-h-screen bg-black text-white font-mono px-6 py-16 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <Link href="/learn/developers" className="text-zinc-400 hover:text-white mb-8 inline-block text-xs uppercase tracking-widest">
          ← Back to Developers
        </Link>

        <div className="border border-zinc-800 bg-zinc-950 p-8">
          <p className="text-[10px] uppercase tracking-widest text-zinc-600 mb-4">Gitlawb Network</p>
          <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">
            Use Gitlawb From Agentbot
          </h1>
          <p className="text-zinc-400 text-sm max-w-2xl leading-relaxed">
            Agentbot already exposes a Gitlawb Network operator surface and links into the live network.
            This page explains the practical path: inspect the network, browse repos, and use the
            decentralized Agentbot mirror as your starting point.
          </p>
        </div>

        <div className="grid gap-px bg-zinc-800 mt-8 md:grid-cols-2">
          <div className="bg-black p-6">
            <div className="text-[10px] uppercase tracking-widest text-zinc-600 mb-3">Agentbot Mirror</div>
            ...
            <a href={AGENTBOT_GITLAWB_WEB_URL} target="_blank" rel="noopener noreferrer" className="text-sm text-red-500 hover:text-white break-all">
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-6 mt-8">
          ...
          <a
            ...
            className="text-sm text-red-500 hover:text-white break-all"
          >
        ...
        <section className="grid gap-4 md:grid-cols-3 mt-8">
          <Link href="/dashboard/gitlawb-network" className="border border-zinc-800 p-5 hover:border-zinc-600 transition-colors">
            <div className="text-[10px] uppercase tracking-widest text-zinc-600 mb-2">Inside Agentbot</div>
            <div className="text-sm font-bold text-white">Open Network Dashboard</div>
            <p className="mt-2 text-xs text-zinc-500">Operator surface, node registry, ref events, and external network links.</p>
          </Link>
          <a href="https://gitlawb.com/node/repos" target="_blank" rel="noopener noreferrer" className="border border-zinc-800 p-5 hover:border-zinc-600 transition-colors">
            <div className="text-[10px] uppercase tracking-widest text-zinc-600 mb-2">On Network</div>
            <div className="text-sm font-bold text-white">Browse Repos</div>
            <p className="mt-2 text-xs text-zinc-500">Inspect mirrored repos, refs, and repo-level network activity.</p>
          </a>
          <a href="https://gitlawb.com/node/events" target="_blank" rel="noopener noreferrer" className="border border-zinc-800 p-5 hover:border-zinc-600 transition-colors">
            <div className="text-[10px] uppercase tracking-widest text-zinc-600 mb-2">Live Feed</div>
            <div className="text-sm font-bold text-white">Open Ref Events</div>
            <p className="mt-2 text-xs text-zinc-500">Watch ref propagation and node activity directly from the network surface.</p>
          </a>
        </section>
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-6 mt-8">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            Agentbot is already linked to the Gitlawb world through the mirrored open-source repo and the in-app network operator screen.
            The next step is deeper live integration, but the teaching path and the mirror path are already here.
          </p>
        </div>
      </div>
    </main>
