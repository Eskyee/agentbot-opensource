      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 grid gap-px bg-zinc-800 md:grid-cols-2">
          <div className="bg-black p-6">
            ...
            <Link href="/dashboard/dj-stream" className="mt-4 inline-block text-sm text-blue-400 hover:text-white">
              Open DJ Stream →
            </Link>
          </div>
          <div className="bg-black p-6">
            ...
            <Link href="/dashboard" className="mt-4 inline-block text-sm text-blue-400 hover:text-white">
