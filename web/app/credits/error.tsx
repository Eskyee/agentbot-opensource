  ...
  return (
    <main className="min-h-screen bg-black text-white font-mono flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        <span className="text-[10px] uppercase tracking-widest text-zinc-600 mb-3 block">Credits Error</span>
        <h1 className="text-2xl font-bold tracking-tighter uppercase mb-4">Couldn&apos;t load credits</h1>
        <p className="text-zinc-400 text-sm mb-6">
          There was a problem loading your credit balance. Try again or check back shortly.
        </p>
