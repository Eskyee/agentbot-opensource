    ...
    return (
      <div className="min-h-screen bg-black text-white p-8 flex items-center justify-center">
        <div className="max-w-xl w-full">
          <Link href="/login">
            <button className="w-full bg-brand-600 hover:bg-brand-500 text-white py-3 px-6 rounded-lg font-semibold">
              Sign In to Start →
            </button>
          </Link>
        </div>
                ...
                <button
                  ...
                  className={`p-4 rounded-xl border-2 transition-all ${
                    wizardData.selectedRole === role.id
                      ? 'border-brand-500 bg-brand-500/10 border-brand-500/50'
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:border-brand-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:border-brand-500 min-h-[100px]"
                />
              </div>
            </div>
          </div>
              ...
              <div className="space-y-3 border-t border-zinc-700 pt-4">
                ...
                {wizardData.channels.discord && (
                  <div>
                    ...
                    <div className="text-brand-400">✓ Enabled</div>
                  </div>
                )}
