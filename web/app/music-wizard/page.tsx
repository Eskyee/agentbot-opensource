    ...
    return (
      <div className="min-h-screen bg-black text-white p-8 flex items-center justify-center">
        <div className="max-w-xl w-full">
          <Link href="/login">
            <button className="w-full bg-red-600 hover:bg-orange-500 text-white py-3 px-6 rounded-lg font-semibold">
              Sign In to Start →
            </button>
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
              ...
              <div className="space-y-3 border-t border-zinc-700 pt-4">
                ...
                {wizardData.channels.discord && (
                  <div>
                    ...
                    <div className="text-orange-500">✓ Enabled</div>
                  </div>
                )}
        ...
        <div className="text-left mt-8">
          <Link href="/signup" className="text-sm text-orange-500 hover:text-orange-500">
