  ...
  return (
    <main className="min-h-screen bg-black text-white font-mono">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <Link href="/" className="text-brand-500 hover:underline mb-8 inline-block text-xs uppercase tracking-widest">
          Back to Home
        </Link>
          ...
          <div className="space-y-8">
            ...
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <p className="text-sm text-zinc-400 mb-3">
                Agentbot integrates with <a href="https://docs.cdp.coinbase.com/agentic-wallet/welcome" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline">Coinbase Agentic Wallet</a>, enabling your agent to execute onchain transactions autonomously. Send payments, interact with smart contracts, and manage crypto assets—all through natural language commands.
              </p>
              <p className="text-sm text-zinc-400">
            ...
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <p className="text-sm text-zinc-400 mb-3">
                Don&apos;t want to build from scratch? Browse our <Link href="/marketplace" className="text-brand-500 hover:underline">marketplace</Link> of pre-configured agents. Each template comes with personality, skills, and use-case-specific configurations ready to go.
              </p>
              <p className="text-sm text-zinc-400 mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-zinc-400 space-y-1 mb-3">
                <li><strong>basefmbot</strong> — Onchain Radio Agent for underground communities (by <a href="https://basefm.space" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline">raveculture</a>)</li>
        ...
        <section id="how-to" className="mb-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm text-zinc-400 mb-4">
                Visit the <Link href="/onboard" className="text-brand-500 hover:underline">onboard page</Link> or browse the <Link href="/marketplace" className="text-brand-500 hover:underline">marketplace</Link> to get started. Deployment takes about one minute and automatically configures the K2.5 Thinking model.
              </p>
              <div className="border border-zinc-800 bg-black p-5">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <div className="bg-zinc-950 border border-zinc-800 p-4">
                ...
                <p className="text-sm text-zinc-400 mb-3">
                  The <strong className="text-white">basefmbot</strong> template (by <a href="https://basefm.space" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline">raveculture</a>) comes pre-configured with deep knowledge of basefm.space, underground radio culture, and onchain community building. It knows how to:
                </p>
                ...
                <p className="text-sm text-zinc-400 mt-3">
                  Deploy from <Link href="/marketplace" className="text-brand-500 hover:underline">marketplace</Link>, customize the personality, and let it run 24/7 across Telegram, Discord, and WhatsApp.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <p className="text-sm text-zinc-400">
                Plans start at {PRICE_START} for the Underground plan. One-click cloud deployment is available on all paid plans. If you already run OpenClaw locally, you can link it to Agentbot for free. See our <Link href="/pricing" className="text-brand-500 hover:underline">pricing page</Link> for details.
              </p>
            </div>
            ...
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <p className="text-sm text-zinc-400">
                First, try refreshing your chat or reconnecting. If that doesn&apos;t work, go to your <Link href="/dashboard" className="text-brand-500 hover:underline">Dashboard</Link> and click &quot;Restart Agent.&quot; Wait for it to restart, then message again. If neither solution works, contact support from the dashboard.
              </p>
            </div>
            ...
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <p className="text-sm text-zinc-400">
                Yes! Agentbot integrates with <a href="https://docs.cdp.coinbase.com/agentic-wallet/welcome" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline">Coinbase Agentic Wallet</a>, enabling your agent to execute onchain transactions autonomously. Your agent can send payments, interact with smart contracts, swap tokens, mint NFTs, and manage crypto assets through natural language commands. This makes it a true autonomous financial assistant for DeFi operations.
              </p>
            </div>
            ...
            <div className="border border-zinc-800 bg-black p-5">
              ...
              <p className="text-sm text-zinc-400 mb-3">
                Absolutely! Visit our <Link href="/marketplace" className="text-brand-500 hover:underline">marketplace</Link> to browse pre-configured agent templates. Each template comes with personality, skills, and use-case-specific configurations.
              </p>
              <p className="text-sm text-zinc-400 mb-3">
