      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section id="comparison" className="mb-16">
          ...
          <div className="mt-6 text-center">
            <Link href="/signup" className="inline-block bg-white text-black px-8 py-3  font-semibold hover:bg-zinc-200">
              Try Agentbot →
            </Link>
          </div>
        </section>
        ...
        <section id="how-to" className="mb-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800  p-6">
                <div className="flex gap-4">
                  <Link href="/onboard?mode=create" className="flex-1 bg-white text-black py-3  text-center font-semibold hover:bg-zinc-200">
                    Create New
                  </Link>
                  <Link href="/onboard?mode=link" className="flex-1 border border-zinc-800 py-3  text-center font-semibold hover:bg-zinc-800">
                    Link Existing
                  </Link>
                  <Link href="/marketplace" className="flex-1 border border-zinc-800 py-3  text-center font-semibold hover:bg-zinc-800">
                    Browse Marketplace
                  </Link>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800  p-6">
                <p className="text-sm text-zinc-500 mb-3">Template:</p>
        ...
        <section id="conclusion" className="mb-16">
          ...
          <div className="bg-zinc-900 border border-zinc-800  p-8 text-center">
            ...
            <p className="text-zinc-400 mb-6">Start from {PRICE_START} with full access.</p>
            <Link href="/signup" className="inline-block bg-white text-black px-8 py-3  font-semibold hover:bg-zinc-200">
              Get Started →
            </Link>
          </div>
