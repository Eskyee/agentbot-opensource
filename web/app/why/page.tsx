  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-mono">
      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <nav className="bg-zinc-900 border border-zinc-800 p-6 mb-12">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-zinc-800">
                  <th className="text-left p-4 bg-zinc-900">Feature</th>
                  <th className="text-left p-4 bg-zinc-900">Agentbot (Cloud)</th>
                  <th className="text-left p-4 bg-zinc-900">Local OpenClaw</th>
                </tr>
              </thead>
              <tbody className="text-zinc-400">
                <tr className="border-b border-zinc-800">
                  <td className="p-4 font-medium">Setup Complexity</td>
                  <td className="p-4 bg-zinc-900">One-click cloud setup, ready in seconds</td>
        ...
        <section id="features" className="mb-16">
          ...
          <div className="space-y-8">
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Persistent memory & custom personality</h3>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Proactive scheduled tasks</h3>
              <p className="text-sm text-zinc-400">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Ready-to-use skills at your fingertips</h3>
              <p className="text-sm text-zinc-400">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Cloud storage included</h3>
              <p className="text-sm text-zinc-400">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Kimi K2.5 Thinking model</h3>
              <p className="text-sm text-zinc-400">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Multi-channel deployment</h3>
              <p className="text-sm text-zinc-400">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Coinbase Agentic Wallet</h3>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">Deploy from Marketplace</h3>
              <p className="text-sm text-zinc-400 mb-3">
        ...
        <section id="how-to" className="mb-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-6">
                <div className="flex flex-col md:flex-row gap-4">
                  <Link href="/onboard?mode=create" className="flex-1 bg-white text-black py-3 text-left text-xs font-bold uppercase tracking-widest hover:bg-zinc-200">
                    Create New
                  </Link>
                  <Link href="/onboard?mode=link" className="flex-1 border border-zinc-800 py-3 text-left text-xs font-bold uppercase tracking-widest hover:bg-zinc-800">
                    Link Existing
                  </Link>
                  <Link href="/marketplace" className="flex-1 border border-zinc-800 py-3 text-left text-xs font-bold uppercase tracking-widest hover:bg-zinc-800">
                    Browse Marketplace
                  </Link>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-6">
                <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-2">Example customization:</p>
            ...
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-6">
                <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-3">Example prompts:</p>
            ...
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-6">
                <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-3">Template:</p>
        ...
        <section id="use-cases" className="mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">1. 24/7 Personal Information Radar</h3>
              <p className="text-sm text-zinc-400 mb-3">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">2. Content creation</h3>
              <p className="text-sm text-zinc-400 mb-3">
              ...
              <div className="bg-zinc-800 p-4">
                <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-2">Example prompt:</p>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">3. Intelligent data visualization</h3>
              <p className="text-sm text-zinc-400 mb-3">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6">
              <h3 className="text-lg font-bold uppercase tracking-tighter mb-3">5. Onchain community management</h3>
              <p className="text-sm text-zinc-400 mb-3">
              ...
              <div className="bg-zinc-800 p-4">
                <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-2">Example: Deploy basefmbot template</p>
                <p className="text-sm text-zinc-400 mb-3">
                  The <strong>basefmbot</strong> template (by <a href="https://basefm.space" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">raveculture</a>) comes pre-configured with deep knowledge of basefm.space, underground radio culture, and onchain community building. It knows how to:
                </p>
        ...
        <div className="text-left py-12 border-t border-zinc-800">
          <Link href="/onboard" className="inline-block bg-white text-black px-8 py-3  font-semibold hover:bg-zinc-200 text-lg">
