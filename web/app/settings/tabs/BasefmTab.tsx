    ...
    <div className="space-y-6 max-w-xl">
      ...
      <div className="rounded-[20px] border border-zinc-800 bg-zinc-950/80 p-5 space-y-4">
        ...
        <p className="text-[10px] text-zinc-600">
          ...
          <a href="https://basefm.space" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline underline-offset-2">
            ...
            <div className="rounded-[20px] border border-zinc-800 bg-zinc-950/80 p-5">
              ...
              {stats.dj.slug && (
                <a
                  ...
                  className="inline-flex items-center gap-1 text-[10px] text-blue-400 hover:text-blue-300 uppercase tracking-widest"
                >
