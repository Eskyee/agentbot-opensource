  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 w-14 h-14 bg-orange-600 hover:bg-orange-500 rounded-full flex items-center justify-center text-white shadow-lg transition-all hover:scale-110 z-50"
      >
        {isOpen ? (
      ...
      {isOpen && (
        <div className="fixed bottom-20 right-4 w-80 h-96 bg-zinc-900 border border-zinc-700 rounded-2xl shadow-2xl flex flex-col z-50">
          {/* Header */}
          <div className="bg-orange-600 px-4 py-3 rounded-t-2xl flex items-center gap-2">
          ...
          >
            ...
            <button
              ...
              className="px-3 py-2 bg-orange-600 text-white rounded-lg text-sm font-bold hover:bg-orange-500 disabled:opacity-50"
            >
              →
            </button>
          </form>
