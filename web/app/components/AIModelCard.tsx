    ...
    <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {config.reasoning === 0 && (
            <button className="w-full mt-3 py-2 text-xs font-bold bg-red-600/20 text-orange-500 border border-orange-500/30 rounded-lg hover:bg-red-600/30 transition-colors">
