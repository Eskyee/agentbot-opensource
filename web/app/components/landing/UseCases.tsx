    ...
    <section className="border-t border-zinc-900">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 py-14 sm:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-900">
          {cases.map((c, i) => (
            <div key={i} className="bg-black p-6 sm:p-8 group hover:bg-zinc-900/50 transition-colors">
              <div className="text-2xl mb-4">{c.icon}</div>
              <h3 className="text-xs sm:text-sm font-bold uppercase tracking-wider mb-2">{c.title}</h3>
