      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 py-14 sm:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-900 mb-10 sm:mb-16">
          <div className="bg-black p-6 sm:p-8">
            <div className="text-[10px] uppercase tracking-widest text-orange-400 mb-3">Africa</div>
          ...
          <div className="bg-black p-6 sm:p-8">
            <div className="text-[10px] uppercase tracking-widest text-orange-400 mb-3">Caribbean</div>
            <h3 className="text-xs sm:text-sm font-bold uppercase tracking-wider mb-3">
              Nerds & Creatives
            </h3>
            <p className="text-zinc-500 text-xs leading-relaxed">
          ...
          <div className="bg-black p-6 sm:p-8">
            <div className="text-[10px] uppercase tracking-widest text-orange-400 mb-3">Global</div>
            <h3 className="text-xs sm:text-sm font-bold uppercase tracking-wider mb-3">
              Research & Explore
            </h3>
            <p className="text-zinc-500 text-xs leading-relaxed">
