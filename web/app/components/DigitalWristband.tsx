...
export default function DigitalWristband() {
  ...
  if (hasWristband) {
    return (
      <div className="p-6 bg-zinc-900 rounded-xl border-2 border-brand-500/50 text-white">
        ...
        <div className="mt-4 pt-4 border-t border-zinc-800">
          <a 
            ...
            className="block text-center text-xs text-zinc-500 hover:text-brand-400 transition-colors"
          >
            View on OpenSea →
          </a>
        </div>
  ...
  return (
    <div className="p-6 bg-zinc-900 rounded-xl border border-zinc-800 text-white">
      ...
      <button 
        ...
        className="w-full py-3 bg-brand-600 hover:bg-brand-500 text-white rounded-lg font-mono text-sm transition-colors"
      >
