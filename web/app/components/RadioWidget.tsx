    ...
    <div className={`bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden ${className}`}>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold">baseFM Radio</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[9px] uppercase tracking-widest text-green-500 border border-green-500/30 px-2 py-0.5 rounded">LIVE</span>
          <button
      ...
      <div className="flex items-center justify-between px-4 py-2 border-t border-zinc-800 bg-zinc-950">
        <span className="text-[9px] text-zinc-600 uppercase tracking-widest">Built in Playground</span>
        <a
