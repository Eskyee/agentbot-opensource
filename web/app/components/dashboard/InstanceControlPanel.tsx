...
export function InstanceControlPanel({
  ...
  return (
    <section className="overflow-hidden rounded-[28px] border border-zinc-800 bg-zinc-950">
      ...
      <div className="grid gap-6 px-6 py-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(300px,0.8fr)] lg:px-8">
          ...
          <div className="grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,1.1fr)_minmax(280px,0.8fr)]">
            ...
            <div className="rounded-[24px] border border-zinc-800 bg-[linear-gradient(180deg,_rgba(245,158,11,0.08),_rgba(9,9,11,0.9))] p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-amber-200/70">KiloClaw Setup</p>
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-400">
                    A KiloClaw expert configures your email, calendar, and messaging live on a call. Includes 2 months free hosting.
                  </p>
                </div>
              </div>
              <Link
