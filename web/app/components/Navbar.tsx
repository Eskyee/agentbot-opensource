        ...
        <div className="hidden md:flex items-center gap-6">
          {!mounted || status === "loading" ? (
            ...
            <>
              ...
              <NavLink href="https://openclaw-gw-ui-production.up.railway.app/chat?session=main" current={pathname}>Borg</NavLink>
            ...
            {isLoggedIn ? (
              <>
                <MobileSection label="Navigate">
                  ...
                  <MobileLink href="https://openclaw-gw-ui-production.up.railway.app/chat?session=main" onClick={closeMenu}>Borg</MobileLink>
