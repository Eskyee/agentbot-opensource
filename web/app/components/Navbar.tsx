        ...
        <div className="hidden md:flex items-center gap-6">
          {!mounted || status === "loading" ? (
            ...
            <>
              ...
              <NavLink href="https://x402-gateway-production.up.railway.app/dashboard" current={pathname}>Borg</NavLink>
            ...
            {isLoggedIn ? (
              <>
                <MobileSection label="Navigate">
                  ...
                  <MobileLink href="https://x402-gateway-production.up.railway.app/dashboard" onClick={closeMenu}>Borg</MobileLink>
