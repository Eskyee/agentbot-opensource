    ...
    <>
      <nav className="w-full flex items-center justify-between px-4 py-3 fixed top-0 z-50 bg-black/80 backdrop-blur-md border-b border-gray-800">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="https://docs.agentbot.raveculture.xyz"    className="text-sm text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white/50 rounded transition-colors">Docs</Link>
      ...
      {menuOpen && (
        ...
        >
          <div className="flex flex-col p-4 gap-1">
            ...
            <Link href="https://docs.agentbot.raveculture.xyz"     className="block text-lg py-3 px-2 text-gray-300 hover:text-white rounded-lg hover:bg-gray-900 active:bg-gray-800" onClick={closeMenu}>Docs</Link>
