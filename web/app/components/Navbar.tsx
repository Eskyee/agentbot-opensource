        ...
        <div className="hidden md:flex items-center gap-6">
          {!mounted || status === "loading" ? (
            ...
            <>
              ...
              <NavLink href="https://YOUR_SERVICE_URL/dashboard" current={pathname}>Borg</NavLink>
            ...
            {isLoggedIn ? (
              <>
                <MobileSection label="Navigate">
                  ...
                  <MobileLink href="https://YOUR_SERVICE_URL/dashboard" onClick={closeMenu}>Borg</MobileLink>
