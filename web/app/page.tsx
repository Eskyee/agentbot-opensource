    ...
    <main className="min-h-screen">
        ...
        <div className="mx-auto max-w-2xl px-4">
          <div className="p-6 rounded-2xl bg-gradient-to-r from-gray-1 to-gray-2 border border-gray-4 shadow-[0_0_0_1px_rgba(0,0,0,0.03),0_8px_16px_rgba(0,0,0,0.15)]">
            ...
            <div className="mt-4 pt-4 border-t border-gray-4 flex items-center justify-center gap-2 text-sm text-gray-7">
              ...
              <a href="/api/stripe/checkout?plan=starter" className="mt-6 block w-full rounded-lg bg-white py-2.5 text-center text-sm font-medium text-black shadow-[0_1px_2px_rgba(0,0,0,0.05),0_4px_8px_rgba(0,0,0,0.1)] hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors">
                Get Started
              </a>
            </div>
            
            {/* Pro */}
            <div className="border border-gray-800 rounded-lg p-6 shadow-[0_1px_2px_rgba(0,0,0,0.1)]">
              <h3 className="text-lg font-medium">Pro</h3>
              ...
              <a href="/api/stripe/checkout?plan=pro" className="mt-6 block w-full rounded-lg border border-gray-700 py-2.5 text-center text-sm font-medium hover:bg-gray-900 hover:border-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400 transition-colors">
                Get Started
              </a>
            </div>
          </div>
      ...
      <section className="px-4 py-24 sm:px-6 lg:px-8 border-t border-gray-900">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Link
            href="/signup"
            className="mt-8 inline-flex items-center justify-center rounded-lg bg-white px-6 py-2.5 text-sm font-medium text-black shadow-[0_1px_2px_rgba(0,0,0,0.05),0_4px_8px_rgba(0,0,0,0.1)] hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors"
          >
            Get Started
          </Link>
        </div>
      ...
      <section id="contact" className="py-20 border-t border-gray-800 scroll-mt-20">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-semibold">Contact Sales</h2>
          <p className="mt-4 text-gray-400">Need custom infrastructure or volume discounts?</p>
          <a
            href="mailto:rbasefm@icloud.com"
            className="mt-8 inline-flex items-center justify-center rounded-lg border border-gray-700 px-6 py-2.5 text-sm font-medium text-white hover:bg-gray-900 hover:border-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400 transition-colors"
          >
            Email Us
          </a>
        </div>
      ...
      <section className="py-20 border-t border-gray-800">
        <div className="mx-auto max-w-2xl px-4">
          <div className="p-6 rounded-2xl bg-gradient-to-r from-gray-900 to-gray-800 border border-gray-700 shadow-[0_1px_2px_rgba(0,0,0,0.1),0_8px_16px_rgba(0,0,0,0.2)]">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-2xl" role="img" aria-label="Lobster">🦞</div>
                <div>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center rounded-lg bg-white text-black px-4 py-2.5 text-sm font-medium hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors"
              >
                Buy AGENTBOT →
              </a>
            </div>
