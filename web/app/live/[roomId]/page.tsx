...
function LiveRoomContent({ roomId }: { roomId: string }) {
...
export default function LiveRoomPage({
  ...
  return (
    <div className="min-h-screen bg-black">
      <Suspense fallback={
        <div className="flex items-center justify-center h-screen font-mono text-xs text-zinc-500 uppercase tracking-widest">
          Synchronizing Live Data...
        </div>
      }>
        <LiveRoomContent roomId={roomId} />
      </Suspense>
    </div>
  )
}
