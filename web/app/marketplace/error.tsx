  ...
  return (
    <main className="min-h-screen bg-black text-white font-mono flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        <span className="text-[10px] uppercase tracking-widest text-zinc-600 mb-3 block">Marketplace Error</span>
        <h1 className="text-2xl font-bold tracking-tighter uppercase mb-4">Failed to load marketplace</h1>
        <p className="text-zinc-400 text-sm mb-6">
          The marketplace couldn&apos;t load. This might be a temporary issue with the database or API.
        </p>
