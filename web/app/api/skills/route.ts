...
const DEFAULT_SKILLS = [
  ...
  { name: 'BYOK MiMo', description: 'Bring Your Own MiMo subscription. Paste your API key and run on your own 82B credit plan.', category: 'ai', author: 'Agentbot', downloads: 0, rating: 5.0, featured: true },
  { name: 'Agentic Market', description: 'Discover and call 1000+ paid AI services. x402 payments. Auto-indexed on Bazaar.', category: 'marketplace', author: 'Agentbot', downloads: 0, rating: 5.0, featured: true },
]
