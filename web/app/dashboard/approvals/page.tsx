      ...
      <DashboardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-zinc-900">
          {[
            ...
            {
              label: 'Denied',
              value: list.filter((a) => a.status === 'denied').length,
              icon: XCircle,
              color: 'text-red-400',
            },
            {
              label: 'Critical',
              value: list.filter((a) => a.risk === 'critical').length,
              icon: AlertTriangle,
              color: 'text-red-400',
            },
          ].map((s) => (
          ...
          <div className="border border-amber-500/20 bg-zinc-950 p-5">
            ...
            <div className="space-y-3">
              {pending.map((approval) => {
                ...
                return (
                  <div key={approval.id} className="border border-zinc-800 bg-black p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {approval.payload && (
                          <pre className="mt-2 text-[10px] text-zinc-500 font-mono bg-zinc-950 p-2 border border-zinc-800 overflow-x-auto">
                      ...
                      <div className="flex gap-2 shrink-0">
                        <button
                          onClick={() =>
                            resolveMutation.mutate({ id: approval.id, decision: 'approved' })
                          }
                        ...
                        <button
                          onClick={() =>
                            resolveMutation.mutate({ id: approval.id, decision: 'denied' })
                          }
                          disabled={resolveMutation.isPending}
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xs text-zinc-500">
                When your agents need permission for high-risk actions, approval requests will
                appear here.
              </p>
            </div>
          ) : (
