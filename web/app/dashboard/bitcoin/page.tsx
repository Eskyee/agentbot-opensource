      ...
      <DashboardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-zinc-800 bg-black/40 p-4">
                ...
                {greenlight?.eligibility.paidMainnet ? (
                  ...
                  <a
                    href="/billing"
                    className="mt-4 w-full inline-flex items-center justify-center gap-2 border border-orange-500/30 bg-orange-500/10 px-4 py-3 text-[10px] font-bold uppercase tracking-widest text-orange-500 hover:bg-orange-500/20 transition-colors"
                  >
        ...
        <div className="grid gap-px bg-zinc-800 grid-cols-1 lg:grid-cols-[380px_minmax(0,1fr)]">
          <section className="bg-zinc-950 border border-zinc-800 p-6">
            ...
            {error && (
              <div className="mt-4 border border-orange-500/30 bg-orange-500/10 px-3 py-3 text-xs text-red-300">
                {error}
              </div>
            )}
          </section>
          ...
          <div className="pt-4 border-t border-zinc-800">
            <div className="flex flex-wrap gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[10px] text-orange-500 hover:text-orange-500"
              >
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="border border-zinc-800 bg-black/40 p-4">
                    ...
                    <button
                      ...
                      className="mt-2 text-[10px] text-orange-500 hover:text-orange-500"
                    >
                      Copy full PSBT
                    </button>
                  </div>
          ...
          <div className="mt-6 pt-4 border-t border-zinc-800">
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 text-[10px] text-orange-500 hover:text-orange-500"
              >
