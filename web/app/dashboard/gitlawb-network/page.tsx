...
export default function GitlawbNetworkPage() {
  ...
  const getEventIcon = (type: string) => {
    switch (type) {
      ...
      case 'GOSSIP': return <Signal className="h-3 w-3 text-red-500" />
      case 'PEER': return <Link2 className="h-3 w-3 text-purple-400" />
      case 'AGENT': return <Users className="h-3 w-3 text-red-500" />
      ...
      <DashboardContent>
                  ...
                  {agent.gitlawb ? (
                    <div className="mt-4 grid gap-px bg-zinc-800 lg:grid-cols-2">
                      ...
                      <div className="bg-black p-4">
                        ...
                        <a href={agent.gitlawb.webUrl} target="_blank" rel="noopener noreferrer" className="text-xs text-red-500 hover:text-white break-all">
        ...
        <div className="border border-zinc-800 bg-zinc-900/50 p-6 mb-6">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            ...
            <div className="text-center p-4 border border-zinc-800">
              <div className="text-2xl font-bold text-red-500">{stats.activeLinks}</div>
              <div className="text-xs text-zinc-500 uppercase tracking-wider">Active Links</div>
            </div>
            <div className="text-center p-4 border border-zinc-800">
              <div className="text-2xl font-bold text-red-500">{stats.recentEvents}</div>
            ...
            {nodes.map((node) => (
              <div key={node.id} className="p-6">
                ...
                <div className="grid grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="text-center p-3 border border-zinc-800">
                    <div className="text-xl font-bold text-red-500">{node.pushes}</div>
                    <div className="text-[10px] text-zinc-500 uppercase tracking-wider">Pushes</div>
                  </div>
                  <div className="text-center p-3 border border-zinc-800">
                    <div className="text-xl font-bold text-red-500">{node.peers.length}</div>
                ...
                <div className="space-y-3 text-xs font-mono mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <code className="text-red-500 flex-1">{node.peerId}</code>
                    <button 
        ...
        <div className="border border-zinc-800 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6">
            ...
            <div className="text-center">
              <div className="text-lg font-bold text-red-500 mb-1">4</div>
              <div className="text-xs text-zinc-500">Peer Routes Active</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-red-500 mb-1">Snapshot</div>
