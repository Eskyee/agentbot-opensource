      ...
      <DashboardHeader
        ...
        action={
          <div className="flex items-center gap-2">
            {plan && (
              <span className="text-[10px] uppercase tracking-widest text-blue-400 bg-blue-900/20 border border-blue-800 rounded px-2 py-0.5 font-mono">
                {plan}
              </span>
            )}
          </div>
        ...
        {subdomainUrl && (
          <div className="border border-zinc-800 bg-zinc-950 p-5">
            ...
            <div className="flex items-center gap-3">
              <code className="text-blue-400 font-mono text-sm flex-1">{subdomainUrl}</code>
              <button
        ...
        {verificationInfo && (
          <div className="border border-emerald-500/30 bg-emerald-500/5 p-5">
            ...
            <div className="mt-3 p-3 bg-zinc-900 border border-zinc-800 rounded">
              ...
              <code className="text-xs text-blue-400 font-mono">{verificationInfo.token}</code>
            </div>
          </div>
        )}
