...
import {
  BookOpen, Upload, Trash2, FileText, Search, Plus,
  Brain, Database, Clock, AlertTriangle, CheckCircle,
} from 'lucide-react'
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-5">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-sm font-bold text-white uppercase tracking-tight mb-2">No documents yet</h3>
