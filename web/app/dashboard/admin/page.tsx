        ...
        <section className="mb-8">
          <div className="mb-3 flex items-end justify-between gap-4">
            ...
            <Link
              ...
              className="text-[10px] uppercase tracking-[0.3em] text-orange-500 hover:text-white"
            >
              Read guide
            </Link>
          </div>
          ...
          <div className="mt-3 rounded-lg border border-zinc-800 bg-zinc-950 p-4">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3">
              <button
                ...
                className="rounded border border-orange-500 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.25em] text-red-400 hover:bg-orange-500 hover:text-black disabled:cursor-not-allowed disabled:border-zinc-800 disabled:text-zinc-600"
              >
