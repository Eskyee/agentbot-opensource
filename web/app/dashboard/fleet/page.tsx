            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-950">
              ...
              {selectedAgent.url && (
                <a
                  ...
                  className="mb-4 block text-[10px] font-mono text-red-500 underline-offset-2 hover:underline truncate"
                >
                  {selectedAgent.url}
                </a>
              )}
              ...
              <div className="mt-4">
                {dashboardUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mb-3 flex items-center justify-center border border-zinc-700 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-red-500 hover:border-red-500"
                  >
                    Open Borg Dashboard
                  </a>
                )}
