              ...
              <div className="mt-4">
                {dashboardUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mb-3 flex items-center justify-center border border-zinc-700 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-orange-400 hover:border-red-500"
                  >
                    Open Borg Dashboard
                  </a>
                )}
