      ...
      <div className="space-y-4">
        ...
        {activeTab === 'streams' && (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="text-3xl font-bold text-brand-400">{metrics.streams.monthlyListeners.toLocaleString()}</div>
        ...
        {activeTab === 'skills' && (
          <div>
            ...
            <div className="text-3xl font-bold text-brand-400">{metrics.skills.active} / {metrics.skills.total}</div>
