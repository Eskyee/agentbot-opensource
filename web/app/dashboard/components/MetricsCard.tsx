        ...
        {currentTab === 'bookings' && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-zinc-800 rounded-xl p-4">
              ...
              <div className="text-2xl font-bold text-red-500">{metrics.bookings.completed}</div>
            </div>
            <div className="bg-zinc-800 rounded-xl p-4">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-zinc-800 rounded-xl p-4">
                ...
                <div className="text-3xl font-bold text-red-500">{metrics.fans.active.toLocaleString()}</div>
              </div>
            </div>
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-zinc-800 rounded-xl p-3 text-center">
                <div className="text-xs text-zinc-500">Superfans</div>
                <div className="text-lg font-bold text-red-500">{metrics.fans.segmentation.superfans}</div>
              </div>
              <div className="bg-zinc-800 rounded-xl p-3 text-center">
                <div className="text-xs text-zinc-500">Casual</div>
                <div className="text-lg font-bold text-red-500">{metrics.fans.segmentation.casual}</div>
              </div>
              <div className="bg-zinc-800 rounded-xl p-3 text-center">
        ...
        {currentTab === 'streams' && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-zinc-800 rounded-xl p-4">
              ...
              <div className="text-2xl font-bold text-red-500">{metrics.streams.monthlyStreams.toLocaleString()}</div>
            </div>
            <div className="bg-zinc-800 rounded-xl p-4">
              <div className="text-xs text-zinc-500 mb-1">Listeners</div>
              <div className="text-2xl font-bold text-red-500">{metrics.streams.monthlyListeners.toLocaleString()}</div>
            </div>
            <div className="bg-zinc-800 rounded-xl p-4">
              <div className="text-xs text-zinc-500 mb-1">Growth</div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-zinc-800 rounded-xl p-4">
                ...
                <div className="text-3xl font-bold text-red-500">{metrics.skills.active}</div>
              </div>
              <div className="bg-zinc-800 rounded-xl p-4">
