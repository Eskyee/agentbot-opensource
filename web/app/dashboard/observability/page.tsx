  ...
  return (
    <DashboardShell className="flex flex-col h-screen overflow-hidden">
      ...
      <DashboardContent className="flex-1 overflow-hidden min-h-0">
        {/* Stats row */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-px bg-zinc-900 mb-6">
          {[
            {
              label: 'Traces',
            ...
            {
              label: 'Total Cost',
              value: stats ? `$${stats.totalCost.toFixed(4)}` : '$0',
              icon: DollarSign,
            ...
            },
            {
              ...
              icon: AlertTriangle,
              color: stats && stats.errorRate > 0.05 ? 'text-red-400' : 'text-emerald-400',
            },
          ].map((s) => (
        ...
        <div className="flex gap-px bg-zinc-900 flex-1 min-h-0">
          {/* Left: trace list */}
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-zinc-500 font-mono">
                      {new Date(trace.startedAt).toLocaleTimeString(undefined, {
                        hour: '2-digit',
                        minute: '2-digit',
                        second: '2-digit',
                      })}
          ...
          <div className="w-[450px] bg-[#0a0a0a] border-l border-zinc-800 overflow-y-auto hidden lg:block">
            {activeTrace ? (
              <>
                ...
                <div className="px-4 py-3 border-b border-zinc-800 grid grid-cols-3 gap-3 text-[10px]">
                  <div>
                    ...
                    <div className="font-mono text-white">
                      {activeTrace.totalDuration != null
                        ? `${(activeTrace.totalDuration / 1000).toFixed(1)}s`
                        : '—'}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="font-mono text-orange-400">
                      {activeTrace.totalTokens.toLocaleString()}
                    </div>
                  </div>
                  <div>
                ...
                <div>
                  <div className="px-4 py-2 border-b border-zinc-800 text-[10px] uppercase tracking-widest text-zinc-500 font-bold">
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <p className="text-xs text-zinc-500">Select a trace to inspect</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="border border-zinc-800 bg-zinc-950 p-5 mt-6">
            ...
            <div className="space-y-2">
              {stats.topErrors.map((err, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 border border-zinc-800 bg-black p-3"
                >
