  ...
  return (
    <DashboardShell>
      <DashboardHeader
        ...
        action={
          <div className="border border-brand-500/30 bg-brand-500/10 px-3 py-1.5">
            <span className="text-[10px] text-brand-400 font-bold uppercase tracking-widest">A2A Negotiator Active</span>
          </div>
        }
      />
                ...
                <div className="flex items-center gap-3">
                  ...
                  {booking.status === 'accepted' && (
                    <div className="text-right">
                      ...
                      <div className="font-mono text-[10px] text-brand-400 truncate w-32">0x{booking.contract_tx_hash || 'pending...'}</div>
                    </div>
                  )}
                </div>
              </div>
