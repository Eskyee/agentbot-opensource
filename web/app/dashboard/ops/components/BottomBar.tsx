...
export function BottomBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-zinc-950 border-t border-zinc-800 px-4 py-1.5 flex items-center gap-4 font-mono text-[10px]">
      ...
      {focusedAgent ? (
        ...
        <span className="text-zinc-600">no focus</span>
      )}
      <span className="text-zinc-700">·</span>
      {activeWorkflow ? (
        <span className="text-zinc-400">
        ...
        <span className="text-zinc-600">no workflow</span>
      )}
      <span className="text-zinc-700">·</span>
      {model ? (
        <span className="text-zinc-400">
        ...
        <span className="text-zinc-600">no model</span>
      )}
      <span className="text-zinc-700">·</span>
      <span className="text-zinc-400">
        queue <span className={queueDepth > 10 ? 'text-yellow-400' : 'text-zinc-200'}>{queueDepth}</span>
      </span>
      <span className="text-zinc-700">·</span>
