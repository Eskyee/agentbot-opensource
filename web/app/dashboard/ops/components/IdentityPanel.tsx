  ...
  return (
    <div className="bg-zinc-950 border border-zinc-800 p-3">
      ...
      <div className="flex items-center gap-2 mb-3">
        <span className="text-[10px] text-zinc-500 shrink-0">DID</span>
      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-1 mb-3">
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-zinc-500 shrink-0">algo</span>
          <span className="text-[10px] font-mono text-zinc-300">{identity.algo}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-zinc-500 shrink-0">issued</span>
          <span className="text-[10px] font-mono text-zinc-300">
            {new Date(identity.issued).toLocaleDateString('en-GB', {
              day: '2-digit',
              month: 'short',
              year: '2-digit',
            })}
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-zinc-500 shrink-0">last sig</span>
          <span className="text-[10px] font-mono text-zinc-300">{identity.lastSig}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-zinc-500 shrink-0">guard</span>
      ...
      <div className="border-t border-zinc-900 pt-2">
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-1">
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-zinc-500 shrink-0">facts</span>
            <span className="text-[10px] font-mono text-zinc-300">
              {identity.facts.count.toLocaleString()}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-zinc-500 shrink-0">lag</span>
            <span
              className={`text-[10px] font-mono ${
                identity.facts.lag < 100 ? 'text-green-400' : 'text-yellow-400'
              }`}
            >
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-zinc-500 shrink-0">leaf</span>
            <span className="text-[10px] font-mono text-zinc-400">{identity.facts.leaf}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-zinc-500 shrink-0">commit</span>
