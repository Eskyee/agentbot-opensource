              ...
              return (
                <div key={section.id} className="bg-zinc-950 border border-zinc-800">
                  ...
                  >
                    ...
                    <span className="text-sm font-bold flex-1 uppercase tracking-tight">
                      {section.title}
                    </span>
                  ...
                  {isOpen && (
                    <ul className="px-5 pb-4 border-t border-zinc-900 pt-3 space-y-2">
                      {section.items.map((item, i) => (
                        <li key={i} className="flex items-start gap-2.5 text-xs text-zinc-400">
                          <span
                            className={`mt-1 w-1 h-1 shrink-0 ${section.color.replace(
                              'text-',
                              'bg-'
                            )}`}
                          />
