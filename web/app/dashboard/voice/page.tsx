...
const voices = [
  {
    ...
    language: 'en-GB',
    gender: 'male',
    desc: 'Deep British accent — authoritative, calm',
  },
  {
    id: 'mimo-tts-2',
    name: 'Nova',
    language: 'en-US',
    gender: 'female',
    desc: 'Clear American accent — friendly, professional',
  },
  {
    id: 'mimo-tts-3',
    name: 'Echo',
    language: 'en-US',
    gender: 'neutral',
    desc: 'Neutral American — versatile, adaptive',
  },
  {
    id: 'mimo-tts-4',
    name: 'Klave',
    language: 'en-GB',
    gender: 'male',
    desc: 'London accent — sharp, direct',
  },
  {
    id: 'mimo-tts-5',
    name: 'Raven',
    language: 'en-US',
    gender: 'female',
    desc: 'Warm American — empathetic, conversational',
  },
];
    ...
    <DashboardShell>
      ...
      <DashboardContent className="space-y-6">
        ...
        {config && !config.ttsEnabled && (
          <div className="border border-red-500/20 bg-zinc-950 p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-sm font-bold text-red-400 uppercase tracking-tight">
                MiMo TTS Not Available
              </h2>
            </div>
            <div className="space-y-3 text-sm text-zinc-400 leading-relaxed max-w-lg">
              <p>
                Voice & TTS requires a MiMo API key. Your agent uses MiMo TTS to convert text
                responses into natural speech for voice notes and phone calls.
              </p>
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="border border-zinc-800 bg-black p-3">
                  ...
                  <div
                    className={cn(
                      'text-xs font-bold',
                      config.hasMimoKey ? 'text-emerald-400' : 'text-red-400'
                    )}
                  >
                ...
                <div className="border border-zinc-800 bg-black p-3">
                  ...
                  <div
                    className={cn(
                      'text-xs font-bold',
                      config.hasBYOK ? 'text-emerald-400' : 'text-zinc-500'
                    )}
                  >
          ...
          {[
            {
              ...
              icon: Volume2,
              color:
                config?.ttsEnabled && config?.ttsReachable
                  ? 'text-emerald-400'
                  : config?.ttsEnabled
                    ? 'text-amber-400'
                    : 'text-red-400',
            ...
            {
              label: 'ASR',
              value: config?.asrEnabled ? 'Active' : 'No Key',
              icon: Mic,
              color: config?.asrEnabled ? 'text-emerald-400' : 'text-red-400',
            },
            {
              label: 'MiMo Plan',
              value: config?.plan?.toUpperCase() ?? 'FREE',
              icon: Zap,
              color: 'text-orange-400',
            },
            {
              label: 'Phone Calls',
              value: config?.callEnabled ? 'Enabled' : 'Coming Soon',
              icon: Phone,
              color: config?.callEnabled ? 'text-orange-400' : 'text-zinc-500',
            },
          ].map((s) => (
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-5">
          ...
          {ttsError && (
            <div className="mt-3 text-xs text-red-400 border border-red-500/20 p-3">{ttsError}</div>
          )}
          {audioUrl && (
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-5">
          ...
          <div className="space-y-4 text-sm text-zinc-400 leading-relaxed max-w-lg">
            <p>
              When enabled, your agents can send and receive voice notes on Telegram, WhatsApp, and
              Discord. MiMo ASR transcribes incoming voice messages. MiMo TTS generates spoken
              responses.
            </p>
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="border border-zinc-800 bg-black p-3">
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-5 opacity-60">
          ...
          <div className="space-y-4 text-sm text-zinc-400 leading-relaxed max-w-lg">
            <p>
              Let your agents make and receive phone calls. Powered by MiMo TTS/ASR with real-time
              conversation capabilities. Users call a dedicated number and talk to their agent
              naturally.
            </p>
