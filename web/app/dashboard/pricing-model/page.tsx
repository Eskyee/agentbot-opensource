      ...
      <DashboardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-zinc-900">
          {[
            ...
            {
              label: 'Resolutions',
              value: metrics?.totalResolutions?.toLocaleString() ?? '0',
              icon: CheckCircle,
              color: 'text-blue-400',
            },
            {
            ...
            },
            {
              ...
              value: `$${(metrics?.avgRevenuePerUnit ?? 0).toFixed(4)}`,
              icon: TrendingUp,
              color: 'text-orange-400',
            },
          ].map((s) => (
        ...
        {selectedModel === 'per_resolution' && (
          <div className="border border-emerald-500/20 bg-zinc-950 p-5">
            ...
            <div className="space-y-4 text-zinc-400 text-sm leading-relaxed max-w-lg">
              <p>
                Your agent only charges when it successfully resolves a task. If the customer isn't
                satisfied or the issue escalates to a human — no charge. This aligns your incentives
                with your users.
              </p>
        ...
        {selectedModel === 'per_token' && (
          <div className="border border-orange-500/20 bg-zinc-950 p-5">
            ...
            <div className="space-y-4 text-zinc-400 text-sm leading-relaxed max-w-lg">
              <p>
                Pure pay-as-you-go. Users buy token credits and your agent consumes them per
                request. Best for variable workloads where usage spikes unpredictably.
              </p>
              <div className="border border-zinc-800 bg-black p-3">
                <div className="text-[10px] text-zinc-500 uppercase tracking-widest mb-1">
                  Tokens Used
        ...
        {selectedModel === 'hybrid' && (
          <div className="border border-sky-500/20 bg-zinc-950 p-5">
            ...
            <div className="space-y-4 text-zinc-400 text-sm leading-relaxed max-w-lg">
              <p>
                Base subscription covers predictable usage. Overage charges kick in when users
                exceed their plan quota. This is how Agentbot's current plans work — and it's the
                most popular model in SaaS right now (43% of companies use hybrid).
              </p>
            ...
            {[
              {
                ...
                tokens: '500K',
                agents: 1,
                features: ['1 Agent', 'MiMo V2.5 Pro', 'Telegram + Discord'],
              },
              {
                name: 'Collective',
                price: '£69',
                tokens: '2M',
                agents: 3,
                features: ['3 Agents', 'Custom Workflows', 'Priority Support'],
              },
              {
                name: 'Label',
                price: '£149',
                tokens: '5M',
                agents: 10,
                features: ['10 Agents', 'Team Management', 'API Access'],
              },
              {
                name: 'Network',
                price: '£499',
                tokens: '20M',
                agents: 999,
                features: ['Unlimited Agents', 'Dedicated Infra', 'Custom Models'],
              },
            ].map((plan) => (
              <div key={plan.name} className="bg-zinc-950 p-5">
                ...
                <div className="space-y-1">
                  {plan.features.map((f) => (
                    <div key={f} className="text-[10px] text-zinc-500 flex items-center gap-1.5">
