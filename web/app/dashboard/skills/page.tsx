    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-zinc-400 mt-2">Browse and install pre-built skills for your agents</p>
        </div>
          ...
          {skills.map((skill: any) => (
            <div key={skill.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
              ...
              <button
                ...
                className="w-full bg-white text-black py-2 rounded-lg font-medium hover:bg-zinc-100 transition-colors"
              >
                Install
              </button>
            </div>
