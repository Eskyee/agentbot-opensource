  ...
  return (
    <DashboardShell>
      ...
      <DashboardContent className="max-w-5xl space-y-8">
        {/* URL Input */}
        <div>
          <div className="text-[10px] uppercase tracking-widest text-zinc-500 mb-2 font-bold">Target URL</div>
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 bg-zinc-900 border border-zinc-800 px-4 py-3 text-sm text-white font-mono placeholder:text-zinc-500 focus:outline-none focus:border-zinc-600"
            />
            {url && (
              <a
                href={url}
        ...
        {/* Quick Actions */}
        <div>
          <div className="text-[10px] uppercase tracking-widest text-zinc-500 mb-3 font-bold">Quick Actions</div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <div className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold">Workflow Builder</div>
            <button
              onClick={addStep}
          ...
          {steps.length === 0 ? (
            <div className="border border-zinc-800 bg-zinc-950 p-8 text-center">
              <Workflow className="h-8 w-8 text-zinc-500 mx-auto mb-3" />
              <p className="text-sm text-zinc-500 font-mono">No workflow steps</p>
            ...
            <div className="space-y-2">
              {steps.map((step, i) => (
                <div key={step.id} className="flex items-center gap-3 border border-zinc-800 bg-zinc-950 p-3">
                  ...
                  {i < steps.length - 1 && <ArrowRight className="h-3 w-3 text-zinc-500 flex-shrink-0" />}
                  <button
        ...
        {result && (
          <div className="border border-zinc-800 bg-zinc-950 p-5">
            <div className="text-[10px] uppercase tracking-widest text-zinc-500 mb-2 font-bold">Result</div>
