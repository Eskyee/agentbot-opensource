...
const UPDATE_BACKUP_DIR = process.env.UPDATE_BACKUP_DIR || path.join(DATA_DIR, 'backups', 'openclaw-updates');
const OPENCLAW_RUNTIME_VERSION = process.env.OPENCLAW_RUNTIME_VERSION || '2026.2.17';
