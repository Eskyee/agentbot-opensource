...
const OPENCLAW_IMAGE = process.env.OPENCLAW_IMAGE || 'ghcr.io/openclaw/openclaw:2026.2.26';
...
const OPENCLAW_RUNTIME_VERSION = process.env.OPENCLAW_RUNTIME_VERSION || '2026.2.26';
